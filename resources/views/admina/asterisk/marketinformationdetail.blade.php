                ...
                <div class="row">
                    <div class="content-box-large">
                        ...
                        <div class="panel-body">
                            {{ Form::open( array( 'url'=>url('/admina/asterisk/postMarketinformation',array('siderType'=>$siderUrl)),
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    {{ Form::label('title', '资讯标题', array('class'=>'col-sm-2 control-label')) }}
                                    <div class="col-sm-10">
                                        @if(empty($notice))
                                            {{ Form::text('title', null, array('class'=>'form-control', 'placeholder'=>'资讯标题')) }}
                                        @else
                                            {{ Form::text('title', $notice->title, array('class'=>'form-control', 'placeholder'=>'资讯标题')) }}
