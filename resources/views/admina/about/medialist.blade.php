                ...
                <div class="row">
                    <div class="content-box-large">
                        <div class="panel-body">
                            ...
                            @endif
                            <div class="col-md-3">
                                <h4>{{ Html::link(url('/admina/about/createMedia'), '创建一篇媒体报道' ) }}</h4>
                            </div>
                                ...
                                @if(!empty($notices))
                                    @foreach ($notices as $notice)
                                        <tr>
                                            ...
                                            <td>
                                                {{ Html::link(url('/admina/about/getMedia', array('id'=>$notice->id)), '修改' ) }}
                                                |{{ Html::link(url('/admina/about/dropMedia', array('id'=>$notice->id)), '删除', array('class'=>'destoryButton') ) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
