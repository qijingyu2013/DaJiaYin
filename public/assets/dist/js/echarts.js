!function (t) {
    ...
    !function () {
        ...
        function n(i, o, n) {
            for (var a = [], h = s[n], l = 0, c = Math.min(i.length, o.length); c > l; l++) {
                var d, u = t(i[l], n);
                switch (u) {
                    case"require":
                        d = h && h.require || e;
        ...
        function r(t) {
            ...
            if (!e.defined) {
                var i = e.factory, o = i.apply(this, n(e.deps || [], i, t));
        ...
        var s = {};
        i = function (t, e, i) {
            s[t] = {id: t, deps: e, factory: i, defined: 0, exports: {}, require: o(t)}
        }, e = o("")
    }(), i("echarts/chart/k", ["require", "./base", "../util/shape/Candle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "../chart"], function (t) {
        function e(t, e, o, n, r) {
            i.call(this, t, e, o, n, r), this.refresh(n)
        }

        var i = t("./base"), o = t("../util/shape/Candle");
        ...
        var r = t("../util/ecData"), s = t("zrender/tool/util");
        return e.prototype = {
            type: n.CHART_TYPE_K, _buildShape: function () {
                var t = this.series;
                this.selectedMap = {};
                for (var e, i = {
                    top: [],
                    bottom: []
                }, o = 0, r = t.length; r > o; o++)t[o].type === n.CHART_TYPE_K && (t[o] = this.reformOption(t[o]), this.legendHoverLink = t[o].legendHoverLink || this.legendHoverLink, e = this.component.xAxis.getAxis(t[o].xAxisIndex), e.type === n.COMPONENT_TYPE_AXIS_CATEGORY && i[e.getPosition()].push(o));
                ...
                if (0 !== n && 0 !== o.length) {
                    this._buildHorizontal(e, n, o);
                    for (var r = 0, s = e.length; s > r; r++)this.buildMark(e[r])
                }
            }, _mapData: function (t) {
                for (var e, i, o = this.series, n = this.component.legend, r = [], s = 0, a = 0, h = t.length; h > a; a++)e = o[t[a]], i = e.name, this.selectedMap[i] = n ? n.isSelected(i) : !0, this.selectedMap[i] && r.push(t[a]), s = Math.max(s, e.data.length);
                return {locationMap: r, maxDataLength: s}
            }, _buildHorizontal: function (t, e, i) {
                for (var o, n, r, s, a, h, l, c, d, u, p = this.series, f = {}, g = 0, m = i.length; m > g; g++) {
                    o = i[g], n = p[o], r = n.xAxisIndex || 0, s = this.component.xAxis.getAxis(r), l = n.barWidth || Math.floor(s.getGap() / 2), u = n.barMaxWidth, u && l > u && (l = u), a = n.yAxisIndex || 0, h = this.component.yAxis.getAxis(a), f[o] = [];
                    for (var _ = 0, y = e; y > _ && null != s.getNameByIndex(_); _++)c = n.data[_], d = this.getDataFromOption(c, "-"), "-" !== d && 4 == d.length && f[o].push([s.getCoordByIndex(_), l, h.getCoord(d[0]), h.getCoord(d[1]), h.getCoord(d[2]), h.getCoord(d[3]), _, s.getNameByIndex(_)])
                }
                this._buildKLine(t, f)
            }, _buildKLine: function (t, e) {
                for (var i, o, r, s, a, h, l, c, d, u, p, f, g, m, _, y, v, x = this.series, b = 0, T = t.length; T > b; b++)if (v = t[b], p = x[v], m = e[v], this._isLarge(m) && (m = this._getLargePointList(m)), p.type === n.CHART_TYPE_K && null != m) {
                    f = p, i = this.query(f, "itemStyle.normal.lineStyle.width"), o = this.query(f, "itemStyle.normal.lineStyle.color"), r = this.query(f, "itemStyle.normal.lineStyle.color0"), s = this.query(f, "itemStyle.normal.color"), a = this.query(f, "itemStyle.normal.color0"), h = this.query(f, "itemStyle.emphasis.lineStyle.width"), l = this.query(f, "itemStyle.emphasis.lineStyle.color"), c = this.query(f, "itemStyle.emphasis.lineStyle.color0"), d = this.query(f, "itemStyle.emphasis.color"), u = this.query(f, "itemStyle.emphasis.color0");
                    for (var S = 0, z = m.length; z > S; S++)_ = m[S], g = p.data[_[6]], f = g, y = _[3] < _[2], this.shapeList.push(this._getCandle(v, _[6], _[7], _[0], _[1], _[2], _[3], _[4], _[5], y ? this.query(f, "itemStyle.normal.color") || s : this.query(f, "itemStyle.normal.color0") || a, this.query(f, "itemStyle.normal.lineStyle.width") || i, y ? this.query(f, "itemStyle.normal.lineStyle.color") || o : this.query(f, "itemStyle.normal.lineStyle.color0") || r, y ? this.query(f, "itemStyle.emphasis.color") || d || s : this.query(f, "itemStyle.emphasis.color0") || u || a, this.query(f, "itemStyle.emphasis.lineStyle.width") || h || i, y ? this.query(f, "itemStyle.emphasis.lineStyle.color") || l || o : this.query(f, "itemStyle.emphasis.lineStyle.color0") || c || r))
                }
            }, _isLarge: function (t) {
                return t[0][1] < .5
            }, _getLargePointList: function (t) {
                for (var e = this.component.grid.getWidth(), i = t.length, o = [], n = 0; e > n; n++)o[n] = t[Math.floor(i / e * n)];
                return o
            }, _getCandle: function (t, e, i, n, s, a, h, l, c, d, u, p, f, g, m) {
                var _ = this.series, y = _[t], v = y.data[e], x = [v, y], b = {
                    zlevel: y.zlevel,
                    z: y.z,
                    clickable: this.deepQuery(x, "clickable"),
                    hoverable: this.deepQuery(x, "hoverable"),
                    style: {x: n, y: [a, h, l, c], width: s, color: d, strokeColor: p, lineWidth: u, brushType: "both"},
                    highlightStyle: {color: f, strokeColor: m, lineWidth: g},
                    _seriesIndex: t
                };
                return b = this.addLabel(b, y, v, i), r.pack(b, y, t, v, e, i), b = new o(b)
            }, getMarkCoord: function (t, e) {
                var i = this.series[t], o = this.component.xAxis.getAxis(i.xAxisIndex), n = this.component.yAxis.getAxis(i.yAxisIndex);
                return ["string" != typeof e.xAxis && o.getCoordByIndex ? o.getCoordByIndex(e.xAxis || 0) : o.getCoord(e.xAxis || 0), "string" != typeof e.yAxis && n.getCoordByIndex ? n.getCoordByIndex(e.yAxis || 0) : n.getCoord(e.yAxis || 0)]
            }, refresh: function (t) {
                ...
                for (var o = this.series, n = {}, s = 0, a = t.length; a > s; s++)n[t[s][0]] = t[s];
                for (var h, l, c, d, u, p, f = 0, s = 0, a = this.shapeList.length; a > s; s++)if (u = this.shapeList[s]._seriesIndex, n[u] && !n[u][3] && "candle" === this.shapeList[s].type) {
                    if (p = r.get(this.shapeList[s], "dataIndex"), d = o[u], n[u][2] && p === d.data.length - 1) {
                    ...
                    l = this.component.xAxis.getAxis(d.xAxisIndex || 0).getGap(), h = n[u][2] ? l : -l, c = 0, f++, this.zr.animate(this.shapeList[s].id, "").when(this.query(this.option, "animationDurationUpdate"), {position: [h, c]}).done(i).start()
                }
                f || e && e()
            }
        }, s.inherits(e, i), t("../chart").define("k", e), e
        ...
        function e(t, e, i, n, r) {
            o.call(this, t, e, i, n, r), this.refresh(n)
        }

        function i(t, e, i) {
            var o = e.x, n = e.y, s = e.width, a = e.height, h = a / 2;
            e.symbol.match("empty") && (t.fillStyle = "#fff"), e.brushType = "both";
            var l = e.symbol.replace("empty", "").toLowerCase();
            l.match("star") ? (h = l.replace("star", "") - 0 || 5, n -= 1, l = "star") : ("rectangle" === l || "arrow" === l) && (o += (s - a) / 2, s = a);
            var c = "";
            if (l.match("image") && (c = l.replace(new RegExp("^image:\\/\\/"), ""), l = "image", o += Math.round((s - a) / 2) - 1, s = a += 2), l = r.prototype.iconLibrary[l]) {
                var d = e.x, u = e.y;
                t.moveTo(d, u + h), t.lineTo(d + 5, u + h), t.moveTo(d + e.width - 5, u + h), t.lineTo(d + e.width, u + h);
                var p = this;
                l(t, {x: o + 4, y: n + 4, width: s - 8, height: a - 8, n: h, image: c}, function () {
                    p.modSelf(), i()
                })
            } else t.moveTo(o, n + h), t.lineTo(o + s, n + h)
        }

        var o = t("./base"), n = t("zrender/shape/Polyline"), r = t("../util/shape/Icon"), s = t("../util/shape/HalfSmoothPolygon");
        t("../component/axis"), t("../component/grid"), t("../component/dataZoom");
        var a = t("../config");
        a.line = {
            zlevel: 0,
        ...
        var h = t("../util/ecData"), l = t("zrender/tool/util"), c = t("zrender/tool/color");
        return e.prototype = {
            type: a.CHART_TYPE_LINE, _buildShape: function () {
                this.finalPLMap = {}, this._buildPosition()
            }, _buildHorizontal: function (t, e, i, o) {
                for (var n, r, s, a, h, l, c, d, u, p = this.series, f = i[0][0], g = p[f], m = this.component.xAxis.getAxis(g.xAxisIndex || 0), _ = {}, y = 0, v = e; v > y && null != m.getNameByIndex(y); y++) {
                    r = m.getCoordByIndex(y);
                    for (var x = 0, b = i.length; b > x; x++) {
                        n = this.component.yAxis.getAxis(p[i[x][0]].yAxisIndex || 0), h = a = c = l = n.getCoord(0);
                        for (var T = 0, S = i[x].length; S > T; T++)f = i[x][T], g = p[f], d = g.data[y], u = this.getDataFromOption(d, "-"), _[f] = _[f] || [], o[f] = o[f] || {
                                min: Number.POSITIVE_INFINITY,
                                max: Number.NEGATIVE_INFINITY,
                                sum: 0,
                                counter: 0,
                                average: 0
                            }, "-" !== u ? (u >= 0 ? (a -= T > 0 ? n.getCoordSize(u) : h - n.getCoord(u), s = a) : 0 > u && (l += T > 0 ? n.getCoordSize(u) : n.getCoord(u) - c, s = l), _[f].push([r, s, y, m.getNameByIndex(y), r, h]), o[f].min > u && (o[f].min = u, o[f].minY = s, o[f].minX = r), o[f].max < u && (o[f].max = u, o[f].maxY = s, o[f].maxX = r), o[f].sum += u, o[f].counter++) : _[f].length > 0 && (this.finalPLMap[f] = this.finalPLMap[f] || [], this.finalPLMap[f].push(_[f]), _[f] = [])
                    }
                    a = this.component.grid.getY();
                    for (var z, x = 0, b = i.length; b > x; x++)for (var T = 0, S = i[x].length; S > T; T++)f = i[x][T], g = p[f], d = g.data[y], u = this.getDataFromOption(d, "-"), "-" == u && this.deepQuery([d, g, this.option], "calculable") && (z = this.deepQuery([d, g], "symbolSize"), a += 2 * z + 5, s = a, this.shapeList.push(this._getCalculableItem(f, y, m.getNameByIndex(y), r, s, "horizontal")))
                }
                ...
                for (var n, r, s, a, h, l, c, d, u, p = this.series, f = i[0][0], g = p[f], m = this.component.yAxis.getAxis(g.yAxisIndex || 0), _ = {}, y = 0, v = e; v > y && null != m.getNameByIndex(y); y++) {
                    s = m.getCoordByIndex(y);
                    for (var x = 0, b = i.length; b > x; x++) {
                        n = this.component.xAxis.getAxis(p[i[x][0]].xAxisIndex || 0), h = a = c = l = n.getCoord(0);
                        for (var T = 0, S = i[x].length; S > T; T++)f = i[x][T], g = p[f], d = g.data[y], u = this.getDataFromOption(d, "-"), _[f] = _[f] || [], o[f] = o[f] || {
                                min: Number.POSITIVE_INFINITY,
                                max: Number.NEGATIVE_INFINITY,
                                sum: 0,
                                counter: 0,
                                average: 0
                            }, "-" !== u ? (u >= 0 ? (a += T > 0 ? n.getCoordSize(u) : n.getCoord(u) - h, r = a) : 0 > u && (l -= T > 0 ? n.getCoordSize(u) : c - n.getCoord(u), r = l), _[f].push([r, s, y, m.getNameByIndex(y), h, s]), o[f].min > u && (o[f].min = u, o[f].minX = r, o[f].minY = s), o[f].max < u && (o[f].max = u, o[f].maxX = r, o[f].maxY = s), o[f].sum += u, o[f].counter++) : _[f].length > 0 && (this.finalPLMap[f] = this.finalPLMap[f] || [], this.finalPLMap[f].push(_[f]), _[f] = [])
                    }
                    a = this.component.grid.getXend();
                    for (var z, x = 0, b = i.length; b > x; x++)for (var T = 0, S = i[x].length; S > T; T++)f = i[x][T], g = p[f], d = g.data[y], u = this.getDataFromOption(d, "-"), "-" == u && this.deepQuery([d, g, this.option], "calculable") && (z = this.deepQuery([d, g], "symbolSize"), a -= 2 * z + 5, r = a, this.shapeList.push(this._getCalculableItem(f, y, m.getNameByIndex(y), r, s, "vertical")))
                }
                for (var C in _)_[C].length > 0 && (this.finalPLMap[C] = this.finalPLMap[C] || [], this.finalPLMap[C].push(_[C]), _[C] = []);
                this._calculMarkMapXY(o, i, "x"), this._buildBorkenLine(t, this.finalPLMap, m, "vertical")
            }, _buildOther: function (t, e, i, o) {
                for (var n, r = this.series, s = {}, a = 0, h = i.length; h > a; a++)for (var l = 0, c = i[a].length; c > l; l++) {
                    var d = i[a][l], u = r[d];
                    n = this.component.xAxis.getAxis(u.xAxisIndex || 0);
                    var p = this.component.yAxis.getAxis(u.yAxisIndex || 0), f = p.getCoord(0);
                    s[d] = s[d] || [], o[d] = o[d] || {
                    ...
                    for (var g = 0, m = u.data.length; m > g; g++) {
                        var _ = u.data[g], y = this.getDataFromOption(_, "-");
                        if (y instanceof Array) {
                            var v = n.getCoord(y[0]), x = p.getCoord(y[1]);
                            s[d].push([v, x, g, y[0], v, f]), o[d].min0 > y[0] && (o[d].min0 = y[0], o[d].minY0 = x, o[d].minX0 = v), o[d].max0 < y[0] && (o[d].max0 = y[0], o[d].maxY0 = x, o[d].maxX0 = v), o[d].sum0 += y[0], o[d].counter0++, o[d].min1 > y[1] && (o[d].min1 = y[1], o[d].minY1 = x, o[d].minX1 = v), o[d].max1 < y[1] && (o[d].max1 = y[1], o[d].maxY1 = x, o[d].maxX1 = v), o[d].sum1 += y[1], o[d].counter1++
                        }
                    }
                }
                for (var b in s)s[b].length > 0 && (this.finalPLMap[b] = this.finalPLMap[b] || [], this.finalPLMap[b].push(s[b]), s[b] = []);
                this._calculMarkMapXY(o, i, "xy"), this._buildBorkenLine(t, this.finalPLMap, n, "other")
            }, _buildBorkenLine: function (t, e, i, o) {
                for (var r, a = "other" == o ? "horizontal" : o, d = this.series, u = t.length - 1; u >= 0; u--) {
                    var p = t[u], f = d[p], g = e[p];
                    if (f.type === this.type && null != g)for (var m = this._getBbox(p, a), _ = this._sIndex2ColorMap[p], y = this.query(f, "itemStyle.normal.lineStyle.width"), v = this.query(f, "itemStyle.normal.lineStyle.type"), x = this.query(f, "itemStyle.normal.lineStyle.color"), b = this.getItemStyleColor(this.query(f, "itemStyle.normal.color"), p, -1), T = null != this.query(f, "itemStyle.normal.areaStyle"), S = this.query(f, "itemStyle.normal.areaStyle.color"), z = 0, C = g.length; C > z; z++) {
                        var E = g[z], w = "other" != o && this._isLarge(a, E);
                        if (w)E = this._getLargePointList(a, E, f.dataFilter); else for (var L = 0, A = E.length; A > L; L++)r = f.data[E[L][2]], (this.deepQuery([r, f, this.option], "calculable") || this.deepQuery([r, f], "showAllSymbol") || "categoryAxis" === i.type && i.isMainAxis(E[L][2]) && "none" != this.deepQuery([r, f], "symbol")) && this.shapeList.push(this._getSymbol(p, E[L][2], E[L][3], E[L][0], E[L][1], a));
                        var M = new n({
                            zlevel: f.zlevel,
                            z: f.z,
                            style: {
                                ...
                                lineWidth: y,
                                lineType: v,
                                smooth: this._getSmooth(f.smooth),
                                smoothConstraint: m,
                                shadowColor: this.query(f, "itemStyle.normal.lineStyle.shadowColor"),
                                shadowBlur: this.query(f, "itemStyle.normal.lineStyle.shadowBlur"),
                                shadowOffsetX: this.query(f, "itemStyle.normal.lineStyle.shadowOffsetX"),
                                shadowOffsetY: this.query(f, "itemStyle.normal.lineStyle.shadowOffsetY")
                            },
                            hoverable: !1,
                            _main: !0,
                            _seriesIndex: p,
                        ...
                        if (h.pack(M, d[p], p, 0, z, d[p].name), this.shapeList.push(M), T) {
                            var k = new s({
                                zlevel: f.zlevel,
                                z: f.z,
                                style: {
                                    miterLimit: y,
                                    pointList: l.clone(E).concat([[E[E.length - 1][4], E[E.length - 1][5]], [E[0][4], E[0][5]]]),
                                    brushType: "fill",
                                    smooth: this._getSmooth(f.smooth),
                                    smoothConstraint: m,
                                    color: S ? S : c.alpha(_, .5)
                                },
                ...
                for (var s = [], a = 0; o > a; a++) {
                    var h = Math.floor(n / o * a), l = Math.min(Math.floor(n / o * (a + 1)), n);
                    if (!(h >= l)) {
                        for (var c = h; l > c; c++)s[c - h] = "horizontal" === t ? e[c][1] : e[c][0];
                        s.length = l - h;
                        for (var d = i(s), u = -1, p = 1 / 0, c = h; l > c; c++) {
                            var f = "horizontal" === t ? e[c][1] : e[c][0], g = Math.abs(f - d);
                            p > g && (u = c, p = g)
                        }
                        var m = e[u].slice();
                        "horizontal" === t ? m[1] = d : m[0] = d, r.push(m)
                    }
                }
                return r
            }, _getSmooth: function (t) {
                return t ? .3 : 0
            }, _getCalculableItem: function (t, e, i, o, n, r) {
                var s = this.series, h = s[t].calculableHolderColor || this.ecTheme.calculableHolderColor || a.calculableHolderColor, l = this._getSymbol(t, e, i, o, n, r);
                return l.style.color = h, l.style.strokeColor = h, l.rotation = [0, 0], l.hoverable = !1, l.draggable = !1, l.style.text = void 0, l
            }, _getSymbol: function (t, e, i, o, n, r) {
                var s = this.series, a = s[t], h = a.data[e], l = this.getSymbolShape(a, t, h, e, i, o, n, this._sIndex2ShapeMap[t], this._sIndex2ColorMap[t], "#fff", "vertical" === r ? "horizontal" : "vertical");
                return l.zlevel = a.zlevel, l.z = a.z + 1, this.deepQuery([h, a, this.option], "calculable") && (this.setCalculable(l), l.draggable = !0), l
            }, getMarkCoord: function (t, e) {
                var i = this.series[t], o = this.xMarkMap[t], n = this.component.xAxis.getAxis(i.xAxisIndex), r = this.component.yAxis.getAxis(i.yAxisIndex);
                if (e.type && ("max" === e.type || "min" === e.type || "average" === e.type)) {
                    var s = null != e.valueIndex ? e.valueIndex : null != o.maxX0 ? "1" : "";
                    return [o[e.type + "X" + s], o[e.type + "Y" + s], o[e.type + "Line" + s], o[e.type + s]]
                }
                return ["string" != typeof e.xAxis && n.getCoordByIndex ? n.getCoordByIndex(e.xAxis || 0) : n.getCoord(e.xAxis || 0), "string" != typeof e.yAxis && r.getCoordByIndex ? r.getCoordByIndex(e.yAxis || 0) : r.getCoord(e.yAxis || 0)]
            }, refresh: function (t) {
                t && (this.option = t, this.series = t.series), this.backupShapeList(), this._buildShape()
            }, ontooltipHover: function (t, e) {
                for (var i, o, n = t.seriesIndex, r = t.dataIndex, s = n.length; s--;)if (i = this.finalPLMap[n[s]])for (var a = 0, h = i.length; h > a; a++) {
                    o = i[a];
                    for (var l = 0, c = o.length; c > l; l++)r === o[l][2] && e.push(this._getSymbol(n[s], o[l][2], o[l][3], o[l][0], o[l][1], "horizontal"))
                }
            }, addDataAnimation: function (t, e) {
                function i() {
                    g--, 0 === g && e && e()
                ...
                for (var n = this.series, r = {}, s = 0, a = t.length; a > s; s++)r[t[s][0]] = t[s];
                for (var h, l, c, d, u, p, f, g = 0, s = this.shapeList.length - 1; s >= 0; s--)if (u = this.shapeList[s]._seriesIndex, r[u] && !r[u][3]) {
                    if (this.shapeList[s]._main && this.shapeList[s].style.pointList.length > 1) {
                        if (p = this.shapeList[s].style.pointList, l = Math.abs(p[0][0] - p[1][0]), d = Math.abs(p[0][1] - p[1][1]), f = "horizontal" === this.shapeList[s]._orient, r[u][2]) {
                            if ("half-smooth-polygon" === this.shapeList[s].type) {
                                var m = p.length;
                                this.shapeList[s].style.pointList[m - 3] = p[m - 2], this.shapeList[s].style.pointList[m - 3][f ? 0 : 1] = p[m - 4][f ? 0 : 1], this.shapeList[s].style.pointList[m - 2] = p[m - 1]
                            }
                            this.shapeList[s].style.pointList.pop(), f ? (h = l, c = 0) : (h = 0, c = -d)
                        } else {
                            if (this.shapeList[s].style.pointList.shift(), "half-smooth-polygon" === this.shapeList[s].type) {
                                var _ = this.shapeList[s].style.pointList.pop();
                                f ? _[0] = p[0][0] : _[1] = p[0][1], this.shapeList[s].style.pointList.push(_)
                            }
                            f ? (h = -l, c = 0) : (h = 0, c = d)
                        }
                        this.shapeList[s].style.controlPointList = null, this.zr.modShape(this.shapeList[s])
                    } else {
                        if (r[u][2] && this.shapeList[s]._dataIndex === n[u].data.length - 1) {
                            this.zr.delShape(this.shapeList[s].id);
                            continue
                        }
                        if (!r[u][2] && 0 === this.shapeList[s]._dataIndex) {
                            this.zr.delShape(this.shapeList[s].id);
                            continue
                        }
                    }
                    this.shapeList[s].position = [0, 0], g++, this.zr.animate(this.shapeList[s].id, "").when(this.query(this.option, "animationDurationUpdate"), {position: [h, c]}).during(o).done(i).start()
                }
                g || e && e()
            }
        }, r.prototype.iconLibrary.legendLineIcon = i, l.inherits(e, o), t("../chart").define("line", e), e
        ...
        function i(t, e, i, o, n) {
            ...
            this.selectedMap = {}, this.lastShapeList = [], this.shapeHandler = {
                onclick: function () {
                    ...
                    var i = e.highlightStyle, o = i.brushTyep, n = i.strokeColor, s = i.lineWidth;
                    i.brushType = "stroke", i.strokeColor = r.ecTheme.calculableColor || l.calculableColor, i.lineWidth = "icon" === e.type ? 30 : 10, r.zr.addHoverShape(e), setTimeout(function () {
                        i && (i.brushType = o, i.strokeColor = n, i.lineWidth = s)
                    }, 20)
                }, ondrop: function (t) {
        ...
        return i.prototype = {
            setCalculable: function (t) {
                ...
                if (this.isDrop && t.target && !e.dragIn) {
                    var i, o = t.target, n = t.dragged, r = c.get(o, "seriesIndex"), s = c.get(o, "dataIndex"), a = this.series, h = this.component.legend;
                    if (-1 === s) {
                        if (c.get(n, "seriesIndex") == r)return e.dragOut = e.dragIn = e.needRefresh = !0, void(this.isDrop = !1);
                        i = {
                            value: c.get(n, "value"),
                            name: c.get(n, "name")
                        ...
                        !d && a[r].data.push(i), h && h.add(i.name, n.style.color || n.style.strokeColor)
                    } else i = a[r].data[s] || "-", null != i.value ? (a[r].data[s].value = "-" != i.value ? p.accAdd(a[r].data[s].value, c.get(n, "value")) : c.get(n, "value"), (this.type === l.CHART_TYPE_FUNNEL || this.type === l.CHART_TYPE_PIE) && (h && 1 === h.getRelatedAmount(i.name) && this.component.legend.del(i.name), i.name += this.option.nameConnector + c.get(n, "name"), h && h.add(i.name, n.style.color || n.style.strokeColor))) : a[r].data[s] = "-" != i ? p.accAdd(a[r].data[s], c.get(n, "value")) : c.get(n, "value");
                ...
                if (this.isDragend && t.target && !e.dragOut) {
                    var i = t.target, o = c.get(i, "seriesIndex"), n = c.get(i, "dataIndex"), r = this.series;
                    if (null != r[o].data[n].value) {
                        r[o].data[n].value = "-";
                        var s = r[o].data[n].name, a = this.component.legend;
                ...
                for (var t, e, i, o, n = this.series, r = {
                    ...
                    right: [],
                    other: []
                }, s = 0, a = n.length; a > s; s++)n[s].type === this.type && (n[s] = this.reformOption(n[s]), this.legendHoverLink = n[s].legendHoverLink || this.legendHoverLink, t = n[s].xAxisIndex, e = n[s].yAxisIndex, i = this.component.xAxis.getAxis(t), o = this.component.yAxis.getAxis(e), i.type === l.COMPONENT_TYPE_AXIS_CATEGORY ? r[i.getPosition()].push(s) : o.type === l.COMPONENT_TYPE_AXIS_CATEGORY ? r[o.getPosition()].push(s) : r.other.push(s));
                ...
                for (var e, i, o, n, r = this.series, s = 0, a = {}, h = "__kener__stack__", c = this.component.legend, d = [], u = 0, p = 0, f = t.length; f > p; p++) {
                    if (e = r[t[p]], o = e.name, this._sIndex2ShapeMap[t[p]] = this._sIndex2ShapeMap[t[p]] || this.query(e, "symbol") || this._symbol[p % this._symbol.length], c) {
                        if (this.selectedMap[o] = c.isSelected(o), this._sIndex2ColorMap[t[p]] = c.getColor(o), n = c.getItemShape(o)) {
                            var g = n.style;
                    ...
                    } else this.selectedMap[o] = !0, this._sIndex2ColorMap[t[p]] = this.zr.getColor(t[p]);
                    this.selectedMap[o] && (i = e.stack || h + t[p], null == a[i] ? (a[i] = s, d[s] = [t[p]], s++) : d[a[i]].push(t[p])), u = Math.max(u, e.data.length)
                }
                ...
                for (var o = this.series, n = 0, r = e.length; r > n; n++)for (var s = 0, a = e[n].length; a > s; s++) {
                    var h = e[n][s], l = "xy" == i ? 0 : "", c = this.component.grid, d = t[h];
                    if ("-1" != i.indexOf("x")) {
                ...
                if (s.show) {
                    var c = t.style;
                    c.text = this._getLabelText(e, i, o, "normal"), c.textPosition = null == s.position ? "horizontal" === n ? "right" : "top" : s.position, c.textColor = h.color, c.textFont = this.getFont(h), c.textAlign = h.align, c.textBaseline = h.baseline
                }
                if (a.show) {
                    var d = t.highlightStyle;
                    d.text = this._getLabelText(e, i, o, "emphasis"), d.textPosition = s.show ? t.style.textPosition : null == a.position ? "horizontal" === n ? "right" : "top" : a.position, d.textColor = l.color, d.textFont = this.getFont(l), d.textAlign = l.align, d.textBaseline = l.baseline
                }
                return t
                ...
                return n ? "function" == typeof n ? n.call(this.myChart, {
                    ...
                    data: e,
                    status: o
                }) : "string" == typeof n ? n = n.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{a0}", t.name).replace("{b0}", i).replace("{c0}", this.numAddCommas(r)) : void 0 : r instanceof Array ? null != r[2] ? this.numAddCommas(r[2]) : r[0] + " , " + r[1] : this.numAddCommas(r)
                ...
                for (var e, i, o = (this.markAttachStyle || {})[t], n = this.series[t], r = m.clone(n.markPoint), s = 0, a = r.data.length; a > s; s++)e = r.data[s], i = this.getMarkCoord(t, e), e.x = null != e.x ? e.x : i[0], e.y = null != e.y ? e.y : i[1], !e.type || "max" !== e.type && "min" !== e.type || (e.value = i[3], e.name = e.name || e.type, e.symbolSize = e.symbolSize || _.getTextWidth(i[3], this.getFont()) / 2 + 5);
                for (var h = this._markPoint(t, r), s = 0, a = h.length; a > s; s++) {
                    var c = h[s];
                    c.zlevel = n.zlevel, c.z = n.z + 1;
                    for (var d in o)c[d] = m.clone(o[d]);
                ...
                for (var e, i = (this.markAttachStyle || {})[t], o = this.series[t], n = m.clone(o.markLine), r = 0, s = n.data.length; s > r; r++) {
                    var a = n.data[r];
                    !a.type || "max" !== a.type && "min" !== a.type && "average" !== a.type ? e = [this.getMarkCoord(t, a[0]), this.getMarkCoord(t, a[1])] : (e = this.getMarkCoord(t, a), n.data[r] = [m.clone(a), {}], n.data[r][0].name = a.name || a.type, n.data[r][0].value = "average" !== a.type ? e[3] : +e[3].toFixed(null != n.precision ? n.precision : this.deepQuery([this.ecTheme, l], "markLine.precision")), e = e[2], a = [{}, {}]), null != e && null != e[0] && null != e[1] && (n.data[r][0].x = null != a[0].x ? a[0].x : e[0][0], n.data[r][0].y = null != a[0].y ? a[0].y : e[0][1], n.data[r][1].x = null != a[1].x ? a[1].x : e[1][0], n.data[r][1].y = null != a[1].y ? a[1].y : e[1][1])
                }
                var c = this._markLine(t, n), d = n.large;
                if (d) {
                    var u = new h({style: {shapeList: c}}), p = c[0];
                    if (p) {
                        m.merge(u.style, p.style), m.merge(u.highlightStyle = {}, p.highlightStyle), u.style.brushType = "stroke", u.zlevel = o.zlevel, u.z = o.z + 1, u.hoverable = !1;
                    ...
                    if (this.type === l.CHART_TYPE_FORCE || this.type === l.CHART_TYPE_CHORD)for (var r = 0, s = c.length; s > r; r++)this.zr.addShape(c[r])
                }
                ...
                var n, r, s, a, h, d, u, p = [], f = e.data, g = o.dataRange, _ = o.legend, y = this.zr.getWidth(), v = this.zr.getHeight();
                if (e.large)n = this.getLargeMarkPointShape(t, e), n._mark = "largePoint", n && p.push(n); else for (var x = 0, b = f.length; b > x; x++)null != f[x].x && null != f[x].y && (s = null != f[x].value ? f[x].value : "", _ && (r = _.getColor(i.name)), g && (r = isNaN(s) ? r : g.getColor(s), a = [f[x], e], h = this.deepQuery(a, "itemStyle.normal.color") || r, d = this.deepQuery(a, "itemStyle.emphasis.color") || h, null == h && null == d) || (r = null == r ? this.zr.getColor(t) : r, f[x].tooltip = f[x].tooltip || e.tooltip || {trigger: "item"}, f[x].name = null != f[x].name ? f[x].name : "", f[x].value = s, n = this.getSymbolShape(e, t, f[x], x, f[x].name, this.parsePercent(f[x].x, y), this.parsePercent(f[x].y, v), "pin", r, "rgba(0,0,0,0)", "horizontal"), n._mark = "point", u = this.deepMerge([f[x], e], "effect"), u.show && (n.effect = u), i.type === l.CHART_TYPE_MAP && (n._geo = this.getMarkGeo(f[x])), c.pack(n, i, t, f[x], x, f[x].name, s), p.push(n)));
                return p
            }, _markLine: function () {
                function t(t, e) {
                ...
                return function (i, o) {
                    var n = this.series[i], r = this.component, s = r.dataRange, a = r.legend;
                    ...
                    for (var d = o.data, u = [], p = this.zr.getWidth(), f = this.zr.getHeight(), _ = 0; _ < d.length; _++) {
                        var y = d[_];
                        if (e(y[0]) && e(y[1])) {
                            var v = this.deepMerge(y), x = [v, o], b = h, T = null != v.value ? v.value : "";
                            if (s) {
                                b = isNaN(T) ? b : s.getColor(T);
                                var S = this.deepQuery(x, "itemStyle.normal.color") || b, z = this.deepQuery(x, "itemStyle.emphasis.color") || S;
                                if (null == S && null == z)continue
                            }
                            y[0].tooltip = v.tooltip || o.tooltip || {trigger: "item"}, y[0].name = y[0].name || "", y[1].name = y[1].name || "", y[0].value = T, u.push({
                    ...
                    if (C) {
                        var E = new g;
                        E.maxTurningAngle = this.query(o, "bundling.maxTurningAngle") / 180 * Math.PI, u = E.run(u)
                    }
                    o.name = n.name;
                    for (var w = [], _ = 0, L = u.length; L > _; _++) {
                        var A = u[_], M = A.rawEdge || A, y = M.rawData, T = null != y.value ? y.value : "", k = this.getMarkLineShape(o, i, y, _, A.points, C, M.color);
                        k._mark = "line";
                        var I = this.deepMerge([y[0], y[1], o], "effect");
                        I.show && (k.effect = I, k.effect.large = o.large), n.type === l.CHART_TYPE_MAP && (k._geo = [this.getMarkGeo(y[0]), this.getMarkGeo(y[1])]), c.pack(k, n, i, y[0], _, y[0].name + ("" !== y[1].name ? " > " + y[1].name : ""), T), w.push(k)
                    }
                    return w
                }
                ...
                null == b && (b = x + 2);
                var T = this.getItemStyleColor(y.color, e, r, i), S = this.getItemStyleColor(v.color, e, r, i), z = m[0], C = m[1], E = new n({
                    style: {
                ...
                return l.match("image") && (E.style.image = l.replace(new RegExp("^image:\\/\\/"), ""), E = new o({
                    style: E.style,
                    highlightStyle: E.highlightStyle,
                    clickable: this.deepQuery(f, "clickable")
                })), null != _ && (E.rotation = [_ * Math.PI / 180, a, h]), l.match("star") && (E.style.iconType = "star", E.style.n = l.replace("empty", "").replace("star", "") - 0 || 5), "none" === l && (E.invisible = !0, E.hoverable = !1), E = this.addLabel(E, t, i, s, p), l.match("empty") && (null == E.style.textColor && (E.style.textColor = E.style.strokeColor), null == E.highlightStyle.textColor && (E.highlightStyle.textColor = E.highlightStyle.strokeColor)), c.pack(E, t, e, i, r, s), E._x = a, E._y = h, E._dataIndex = r, E._seriesIndex = e, E
            }, getMarkLineShape: function (t, e, i, o, n, s, h) {
                ...
                g.color = this.getItemStyleColor(g.color, e, o, i);
                ...
                return s ? (z.pointList = n, z.smooth = b) : (z.xStart = n[0][0], z.yStart = n[0][1], z.xEnd = n[1][0], z.yEnd = n[1][1], z.curveness = b, S.updatePoints(S.style)), S = this.addLabel(S, t, i[0], i[0].name + " : " + i[1].name)
            }, getLargeMarkPointShape: function (t, e) {
                var i, o, n, r, a, h, l = this.series[t], c = this.component, d = e.data, u = c.dataRange, p = c.legend, f = [d[0], e];
                if (p && (o = p.getColor(l.name)), !u || (n = null != d[0].value ? d[0].value : "", o = isNaN(n) ? o : u.getColor(n), r = this.deepQuery(f, "itemStyle.normal.color") || o, a = this.deepQuery(f, "itemStyle.emphasis.color") || r, null != r || null != a)) {
                ...
                var t, e, i = this.option.animationThreshold / (this.canvasSupported ? 2 : 4), o = this.lastShapeList, n = this.shapeList, r = o.length > 0, s = r ? this.query(this.option, "animationDurationUpdate") : this.query(this.option, "animationDuration"), a = this.query(this.option, "animationEasing"), h = {}, c = {};
                if (this.option.animation && !this.option.renderAsImage && n.length < i && !this.motionlessOnce) {
                    for (var d = 0, u = o.length; u > d; d++)e = this._getAnimationKey(o[d]), e.match("undefined") ? this.zr.delShape(o[d].id) : (e += o[d].type, h[e] ? this.zr.delShape(o[d].id) : h[e] = o[d]);
                    ...
                    for (var d = 0, u = n.length; u > d; d++)this.zr.addShape(n[d])
                }
            ...
            }, _animateMod: function (t, e, i, o, n, r) {
                switch (e.type) {
                    case"polyline":
                    case"half-smooth-polygon":
                        d.pointList(this.zr, t, e, i, o);
                        break;
                    case"rectangle":
                        d.rectangle(this.zr, t, e, i, o);
                        break;
                    case"image":
                    case"icon":
                        d.icon(this.zr, t, e, i, o, n);
                        break;
                    case"candle":
                        r ? this.zr.addShape(e) : d.candle(this.zr, t, e, i, o);
                        break;
                    case"ring":
                    case"sector":
                    case"circle":
                        r ? "sector" === e.type ? d.sector(this.zr, t, e, i, o) : this.zr.addShape(e) : d.ring(this.zr, t, e, i + (c.get(e, "dataIndex") || 0) % 20 * 100, o);
                        break;
                    case"text":
                        d.text(this.zr, t, e, i, o);
                        break;
                    case"polygon":
                        r ? d.pointList(this.zr, t, e, i, o) : d.polygon(this.zr, t, e, i, o);
                        break;
                    case"ribbon":
                        d.ribbon(this.zr, t, e, i, o);
                        break;
                    case"gauge-pointer":
                        d.gaugePointer(this.zr, t, e, i, o);
                        break;
                    case"mark-line":
                        d.markline(this.zr, t, e, i, o);
                        break;
                    case"bezier-curve":
                    case"line":
                        d.line(this.zr, t, e, i, o);
                        break;
                    default:
                        this.zr.addShape(e)
                }
                ...
                if (!t && this.clearEffectShape(), t = t || this.shapeList, null != t) {
                    ...
                    for (var i, o = 0, n = t.length; n > o; o++)i = t[o], i._mark && i.effect && i.effect.show && u[i._mark] && (u[i._mark](this.zr, this.effectList, i, e), this.effectList[this.effectList.length - 1]._mark = i._mark)
                }
                ...
                if (this.selectedMap[o.name]) {
                    var n = this.query(this.option, "animationDurationUpdate"), r = this.query(this.option, "animationEasing"), s = o[i].data, a = this.shapeList.length;
                ...
                var o = this.series[t];
                if (this.selectedMap[o.name]) {
                    for (var n = !1, r = [this.shapeList, this.effectList], s = 2; s--;)for (var a = 0, h = r[s].length; h > a; a++)if (r[s][a]._mark == i && c.get(r[s][a], "seriesIndex") == t && c.get(r[s][a], "name") == e) {
                        this.zr.delShape(r[s][a].id), r[s].splice(a, 1), n = !0;
                        break
                    }
        ...
        return e.prototype = {
            type: n.COMPONENT_TYPE_AXIS, axisBase: {
                _buildAxisLine: function () {
                    ...
                    var r = i.style;
                    "" !== this.option.name && (r.text = this.option.name, r.textPosition = this.option.nameLocation, r.textFont = this.getFont(this.option.nameTextStyle), this.option.nameTextStyle.align && (r.textAlign = this.option.nameTextStyle.align), this.option.nameTextStyle.baseline && (r.textBaseline = this.option.nameTextStyle.baseline), this.option.nameTextStyle.color && (r.textColor = this.option.nameTextStyle.color)), r.strokeColor = this.option.axisLine.lineStyle.color, r.lineWidth = t, this.isHorizontal() ? r.yStart = r.yEnd = this.subPixelOptimize(r.yEnd, t) : r.xStart = r.xEnd = this.subPixelOptimize(r.xEnd, t), r.lineType = this.option.axisLine.lineStyle.type, i = new o(i), this.shapeList.push(i)
        ...
        var i = t("./base"), o = t("zrender/shape/Rectangle"), n = t("../config");
        n.grid = {
            zlevel: 0,
            z: 0,
            x: 80,
        ...
        var i = t("./base"), o = t("zrender/shape/Rectangle"), n = t("zrender/shape/Polygon"), r = t("../util/shape/Icon"), s = t("../config");
        s.dataZoom = {
            zlevel: 0,
            z: 4,
            show: !1,
        ...
        return e.prototype = {
            type: s.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
                ...
                for (var c, h = 0, l = t.length; l > h; h++)if (c = t[h], c.type == s.CHART_TYPE_LINE || c.type == s.CHART_TYPE_BAR || c.type == s.CHART_TYPE_SCATTER || c.type == s.CHART_TYPE_K) {
                    for (var d = 0, u = o.length; u > d; d++)if (o[d] == (c.xAxisIndex || 0)) {
                        r.push(h);
                        break
                    }
                    for (var d = 0, u = n.length; u > d; d++)if (n[d] == (c.yAxisIndex || 0)) {
                        r.push(h);
                        break
                    }
                ...
                for (var a, h = this.option.series, l = this._zoom.seriesIndex, i = 0, o = l.length; o > i; i++)a = h[l[i]], this._originalData.series[l[i]] = a.data, a.data && this.getDataFromOption(a.data[0]) instanceof Array && (a.type == s.CHART_TYPE_SCATTER || a.type == s.CHART_TYPE_LINE || a.type == s.CHART_TYPE_BAR) && (this._backupScale(), this._calculScatterMap(l[i]))
                ...
                for (var h = 0, l = i; l > h; h += b)u = this.getDataFromOption(f[h], 0), this.option.series[p].type == s.CHART_TYPE_K && (u = u[1]), isNaN(u) && (u = 0), y.push("horizontal" == this.zoomOption.orient ? [this._location.x + v * h, this._location.y + e - 1 - Math.round((u - m) / _ * (e - 10))] : [this._location.x + 1 + Math.round((u - m) / _ * (t - 10)), this._location.y + x * (l - h - 1)]);
                ...
                var t = this.zoomOption.showDetail ? this._getDetail() : {start: "", end: ""};
                this._startShape = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    draggable: !0,
                    ...
                    highlightStyle: {text: t.start, brushType: "fill", textPosition: "left"},
                    ondrift: this._ondrift,
                    ondragend: this._ondragend
                ...
                for (var a in this._originalData) {
                    ...
                    for (var h in e)r = e[h], null != r && (n = r.length, i = Math.floor(this._zoom.start / 100 * n), o = Math.ceil(this._zoom.end / 100 * n), this.getDataFromOption(r[0]) instanceof Array && this.option[a][h].type != s.CHART_TYPE_K ? (this._setScale(), this.option[a][h].data = this._synScatterData(h, r)) : this.option[a][h].data = r.slice(i, o))
                }
                ...
                var l;
                (l = h.x.dataMappingMethods) && (o = l.coord2Value(o), n = l.coord2Value(n)), (l = h.y.dataMappingMethods) && (r = l.coord2Value(r), s = l.coord2Value(s));
                for (var c, d = 0, u = e.length; u > d; d++)c = e[d].value || e[d], c[0] >= o && c[0] <= n && c[1] >= r && c[1] <= s && a.push(e[d]);
                return a
            }, _setScale: function () {
                ...
                for (var t = ["xAxis", "yAxis"], e = 0, i = t.length; i > e; e++) {
                    ...
                    for (var n in o) {
                        var r = o[n];
                        if (null != r) {
                            var s = r.length, h = Math.floor(this._zoom.start / 100 * s), l = Math.ceil(this._zoom.end / 100 * s);
                            return l -= l > 0 ? 1 : 0, {
                ...
                var c = this._zoom.seriesIndex[0], d = this.option.series[c][t + "Index"] || 0, u = this.option[t][d].type, p = this._zoom.scatterMap[c][t.charAt(0)].min, f = this._zoom.scatterMap[c][t.charAt(0)].max, g = f - p;
                if ("value" == u)return {start: p + g * this._zoom.start / 100, end: p + g * this._zoom.end / 100};
                if ("time" == u) {
                    f = p + g * this._zoom.end / 100, p += g * this._zoom.start / 100;
                    var m = a.getAutoFormatter(p, f).formatter;
                    return {start: a.format(m, p), end: a.format(m, f)}
                }
                return {start: "", end: ""}
        ...
        function i(t) {
            if ("object" == typeof t && null !== t) {
                ...
                if (t instanceof Array) {
                    o = [];
                    for (var n = 0, r = t.length; r > n; n++)o[n] = i(t[n])
                } else if (!_[y.call(t)] && !e(t)) {
                    o = {};
                    for (var s in t)t.hasOwnProperty(s) && (o[s] = i(t[s]))
                }
                return o
            }
            return t
        ...
        function o(t, i, o, r) {
            if (i.hasOwnProperty(o)) {
                var s = t[o];
                "object" != typeof s || _[y.call(s)] || e(s) ? !r && o in t || (t[o] = i[o]) : n(t[o], i[o], r)
            }
        }
        ...
        function h(t, e, i) {
            if (t && e)if (t.forEach && t.forEach === f)t.forEach(e, i); else if (t.length === +t.length)for (var o = 0, n = t.length; n > o; o++)e.call(i, t[o], o, t); else for (var r in t)t.hasOwnProperty(r) && e.call(i, t[r], r, t)
        }

        function l(t, e, i) {
            if (t && e) {
                if (t.map && t.map === g)return t.map(e, i);
                for (var o = [], n = 0, r = t.length; r > n; n++)o.push(e.call(i, t[n], n, t));
                return o
            }
        }
        ...
        function c(t, e, i) {
            if (t && e) {
                ...
                for (var o = [], n = 0, r = t.length; r > n; n++)e.call(i, t[n], n, t) && o.push(t[n]);
                return o
            }
        }
        ...
        return {inherits: a, clone: i, merge: n, getContext: r, indexOf: s, each: h, map: l, filter: c, bind: d}
            ...
            type: "polyline", buildPath: function (t, e) {
                ...
                if (!(o.length < 2)) {
                    ...
                    if (e.smooth && "spline" !== e.smooth) {
                        ...
                        for (var a, h, l, c = 0; r - 1 > c; c++)a = s[2 * c], h = s[2 * c + 1], l = o[c + 1], t.bezierCurveTo(a[0], a[1], h[0], h[1], l[0], l[1])
                    } else if ("spline" === e.smooth && (o = i(o), r = o.length), e.lineType && "solid" != e.lineType) {
                        if ("dashed" == e.lineType || "dotted" == e.lineType) {
                            var d = (e.lineWidth || 1) * ("dashed" == e.lineType ? 5 : 1);
                            t.moveTo(o[0][0], o[0][1]);
                            for (var c = 1; r > c; c++)n(t, o[c - 1][0], o[c - 1][1], o[c][0], o[c][1], d)
                        }
                    } else {
                        t.moveTo(o[0][0], o[0][1]);
                        for (var c = 1; r > c; c++)t.lineTo(o[c][0], o[c][1])
                    }
                }
        ...
        var i = t("zrender/shape/Base"), o = t("zrender/shape/util/smoothBezier"), n = t("zrender/tool/util");
        return e.prototype = {
            type: "half-smooth-polygon", buildPath: function (e, i) {
                var n = i.pointList;
                if (!(n.length < 2))if (i.smooth) {
                    var r = o(n.slice(0, -2), i.smooth, !1, i.smoothConstraint);
                    e.moveTo(n[0][0], n[0][1]);
                    for (var s, a, h, l = n.length, c = 0; l - 3 > c; c++)s = r[2 * c], a = r[2 * c + 1], h = n[c + 1], e.bezierCurveTo(s[0], s[1], a[0], a[1], h[0], h[1]);
        ...
        function p(t, e) {
            for (var i = e.x, o = e.y, n = e.width, r = e.height, s = Math.round(r / 3), a = Math.round((s - 2) / 2), h = 3; h--;)t.rect(i, o + s * h + a, n, 2)
        }

        function f(t, e) {
            for (var i = e.x, o = e.y, n = e.width, r = e.height, s = Math.round(n / 3), a = Math.round((s - 2) / 2), h = 3; h--;)t.rect(i + s * h + a, o, 2, r)
        }
        ...
        function l(t, e, i) {
            ...
            for (var o = [], n = (e[0] - t[0]) / i, r = (e[1] - t[1]) / i, s = (e[2] - t[2]) / i, a = (e[3] - t[3]) / i, h = 0, l = t[0], c = t[1], u = t[2], p = t[3]; i > h; h++)o[h] = d([P(Math.floor(l), [0, 255]), P(Math.floor(c), [0, 255]), P(Math.floor(u), [0, 255]), p.toFixed(4) - 0], "rgba"), l += n, c += r, u += s, p += a;
            return l = e[0], c = e[1], u = e[2], p = e[3], o[h] = d([l, c, u, p], "rgba"), o
        }
        ...
        function p(t, e) {
            if (!O(t))return t;
            var i = M(t), o = i[3];
            return "undefined" == typeof o && (o = 1), t.indexOf("hsb") > -1 ? i = D(i) : t.indexOf("hsl") > -1 && (i = R(i)), e.indexOf("hsb") > -1 || e.indexOf("hsv") > -1 ? i = B(i) : e.indexOf("hsl") > -1 && (i = F(i)), i[3] = o, d(i, e)
        }
        ...
        function L(t, e, i) {
            ...
            var u = n[3] * i + r[3] * (1 - i);
            return u = Math.max(0, Math.min(1, u)), 1 === n[3] && 1 === r[3] ? d(l, "rgb") : (l[3] = u, d(l, "rgba"))
        }
        ...
        function M(t) {
            ...
            var i, o, n, r = [];
            if (e[2])i = e[2].replace("#", "").split(""), n = [i[0] + i[1], i[2] + i[3], i[4] + i[5]], r = I(n, function (t) {
                return P(parseInt(t, 16), [0, 255])
            }); else if (e[4]) {
                var s = e[4].split(",");
                o = s[3], n = s.slice(0, 3), r = I(n, function (t) {
        ...
        function k(t, e) {
            ...
            null === e && (e = 1);
            var i = M(f(t));
            return i[3] = P(Number(e).toFixed(4), [0, 1]), d(i, "rgba")
        }
        ...
        function D(t) {
            ...
            if (0 === r)e = 255 * s, i = 255 * s, o = 255 * s; else {
                ...
                0 === h ? (u = s, p = d, f = l) : 1 === h ? (u = c, p = s, f = l) : 2 === h ? (u = l, p = s, f = d) : 3 === h ? (u = l, p = c, f = s) : 4 === h ? (u = d, p = l, f = s) : (u = s, p = l, f = c), e = 255 * u, i = 255 * p, o = 255 * f
            }
            return [e, i, o]
        }
        ...
        function B(t) {
            ...
            if (0 === h)e = 0, i = 0; else {
                ...
                o === a ? e = u - d : n === a ? e = 1 / 3 + c - u : r === a && (e = 2 / 3 + d - c), 0 > e && (e += 1), e > 1 && (e -= 1)
            }
        ...
        var N, Y = t("../tool/util"), W = ["#ff9277", " #dddd00", " #ffc877", " #bbe3ff", " #d5ffbb", "#bbbbff", " #ddb000", " #b0dd00", " #e2bbff", " #ffbbe3", "#ff7777", " #ff9900", " #83dd00", " #77e3ff", " #778fff", "#c877ff", " #ff77ab", " #ff6600", " #aa8800", " #77c7ff", "#ad77ff", " #ff77ff", " #dd0083", " #777700", " #00aa00", "#0088aa", " #8400dd", " #aa0088", " #dd0000", " #772e00"], q = W, X = "rgba(255,255,0,0.5)", G = X, V = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, Z = {
            aliceblue: "#f0f8ff",
            antiquewhite: "#faebd7",
            aqua: "#0ff",
            aquamarine: "#7fffd4",
            ...
            type: "image", brush: function (t, e, i) {
                ...
                if (n) {
                    ...
                    if (t.save(), this.doClip(t), this.setContext(t, o), this.setTransform(t), o.sWidth && o.sHeight) {
                        var d = o.sx || 0, u = o.sy || 0;
                        t.drawImage(n, d, u, o.sWidth, o.sHeight, l, c, a, h)
                    } else if (o.sx && o.sy) {
                        var d = o.sx, u = o.sy, p = a - d, f = h - u;
                        t.drawImage(n, d, u, p, f, l, c, a, h)
                    } else t.drawImage(n, l, c, a, h);
        ...
        var n = t("./config"), r = t("zrender/tool/util"), s = t("zrender/tool/event"), a = {}, h = t("zrender/tool/env").canvasSupported, l = new Date - 0, c = {}, d = "_echarts_instance_";
        a.version = "2.2.7", a.dependencies = {zrender: "2.1.1"}, a.init = function (e, o) {
            var n = t("zrender");
            ...
            return r || (r = l++, e.setAttribute(d, r)), c[r] && c[r].dispose(), c[r] = new i(e), c[r].id = r, c[r].canvasSupported = h, c[r].setTheme(o), c[r]
        ...
        return i.prototype = {
            _init: function () {
                ...
                for (var e = t.series, i = 0, o = e.length; o > i; i++)if (e[i].type == n.CHART_TYPE_MAP || e[i].data && e[i].data.length > 0 || e[i].markPoint && e[i].markPoint.data && e[i].markPoint.data.length > 0 || e[i].markLine && e[i].markLine.data && e[i].markLine.data.length > 0 || e[i].nodes && e[i].nodes.length > 0 || e[i].links && e[i].links.length > 0 || e[i].matrix && e[i].matrix.length > 0 || e[i].eventList && e[i].eventList.length > 0)return !1;
                var r = this._option && this._option.noDataLoadingOption || this._themeConfig.noDataLoadingOption || n.noDataLoadingOption || {
                ...
                for (var i = ["backgroundColor", "calculable", "calculableColor", "calculableHolderColor", "nameConnector", "valueConnector", "animation", "animationThreshold", "animationDuration", "animationDurationUpdate", "animationEasing", "addDataAnimation", "symbolList", "DRAG_ENABLE_TIME"], o = i.length; o--;) {
                    var r = i[o];
                    null == e[r] && (e[r] = null != this._themeConfig[r] ? this._themeConfig[r] : n[r])
                }
                var s = e.color;
                s && s.length || (s = this._themeConfig.color || n.color), this._zr.getColor = function (e) {
                ...
                function a() {
                    if (d._zr) {
                        ...
                        d._messageCenter.dispatch(n.EVENT.REFRESH, null, {option: l}, d)
                    }
                }

                for (var h = t instanceof Array ? t : [[t, e, i, o, s]], l = this.getOption(), c = this._optionRestore, d = this, u = 0, p = h.length; p > u; u++) {
                    t = h[u][0], e = h[u][1], i = h[u][2], o = h[u][3], s = h[u][4];
                    var f = c.series[t], g = i ? "unshift" : "push", m = i ? "pop" : "shift";
                    if (f) {
                        var _ = f.data, y = l.series[t].data;
                        if (_[g](e), y[g](e), o || (_[m](), e = y[m]()), null != s) {
                            var v, x;
                            if (f.type === n.CHART_TYPE_PIE && (v = c.legend) && (x = v.data)) {
                                var b = l.legend.data;
                                if (x[g](s), b[g](s), !o) {
                                    var T = r.indexOf(x, e.name);
                                    -1 != T && x.splice(T, 1), T = r.indexOf(b, e.name), -1 != T && b.splice(T, 1)
                                }
                            } else if (null != c.xAxis && null != c.yAxis) {
                                var S, z, C = f.xAxisIndex || 0;
                                (null == c.xAxis[C].type || "category" === c.xAxis[C].type) && (S = c.xAxis[C].data, z = l.xAxis[C].data, S[g](s), z[g](s), o || (S[m](), z[m]())), C = f.yAxisIndex || 0, "category" === c.yAxis[C].type && (S = c.yAxis[C].data, z = l.yAxis[C].data, S[g](s), z[g](s), o || (S[m](), z[m]()))
                            }
                        }
        ...
        var i = t("zrender/shape/Base"), o = t("./Icon"), n = t("zrender/shape/Line"), r = new n({}), s = t("zrender/shape/BezierCurve"), a = new s({}), h = t("zrender/tool/area"), l = t("zrender/shape/util/dashedLineTo"), c = t("zrender/tool/util"), d = t("zrender/tool/curve");
        return e.prototype = {
            type: "mark-line", brush: function (t, e) {
                ...
                var e = t.curveness || 0, i = 1, o = t.xStart, n = t.yStart, r = t.xEnd, s = t.yEnd, a = (o + r) / 2 - i * (n - s) * e, h = (n + s) / 2 - i * (r - o) * e;
                t.cpX1 = a, t.cpY1 = h
                ...
                if ("none" != e.symbol[i]) {
                    ...
                    var r = e.xStart, s = e.yStart, a = e.xEnd, h = e.yEnd, l = 0 === i ? r : a, c = 0 === i ? s : h, u = e.curveness || 0, p = null != e.symbolRotate[i] ? e.symbolRotate[i] - 0 : 0;
                    if (p = p / 180 * Math.PI, "arrow" == n && 0 === p)if (0 === u) {
                        var f = 0 === i ? -1 : 1;
                        p = Math.PI / 2 + Math.atan2(f * (h - s), f * (a - r))
                    } else {
                        var g = e.cpX1, m = e.cpY1, _ = d.quadraticDerivativeAt, y = _(r, g, a, i), v = _(s, m, h, i);
        ...
        return e.prototype = {
            type: "symbol", buildPath: function (t, e) {
                ...
                if (0 !== o)for (var n, r, s, a, h, l = 1e4, c = Math.ceil(o / l), d = i[0] instanceof Array, u = e.size ? e.size : 2, p = u, f = u / 2, g = 2 * Math.PI, m = 0; c > m; m++) {
                    t.beginPath(), n = m * l, r = n + l, r = r > o ? o : r;
                    for (var _ = n; r > _; _++)if (e.random && (s = e["randomMap" + _ % 20] / 100, p = u * s * s, f = p / 2), d ? (a = i[_][0], h = i[_][1]) : (a = i[_].x, h = i[_].y), 3 > p)t.rect(a - f, h - f, p, p); else switch (e.iconType) {
                        case"circle":
        ...
        return i.prototype = {
            constructor: i, type: "shape-bundle", brush: function (t, e) {
                ...
                for (var o = 0; o < i.shapeList.length; o++) {
                    var n = i.shapeList[o], r = n.style;
                    e && (r = n.getHighlightStyle(r, n.highlightStyle || {}, n.brushTypeOnly)), n.buildPath(t, r)
                }
                switch (i.brushType) {
                    case"both":
                        t.fill();
                ...
                for (var e = 1 / 0, i = -1 / 0, o = 1 / 0, n = -1 / 0, r = 0; r < t.shapeList.length; r++)var s = t.shapeList[r], a = s.getRect(s.style), e = Math.min(a.x, e), o = Math.min(a.y, o), i = Math.max(a.x + a.width, i), n = Math.max(a.y + a.height, n);
                return t.__rect = {x: e, y: o, width: i - e, height: n - o}, t.__rect
            }, isCover: function (t, e) {
                var i = this.transformCoordToLocal(t, e);
                if (t = i[0], e = i[1], this.isCoverRect(t, e))for (var o = 0; o < this.style.shapeList.length; o++) {
        ...
        function e(t, e, i, o, n) {
            ...
            if (!e) {
                if (r = [], "vertical" != i._orient)for (var h = s[0][1], l = 0; a > l; l++)r[l] = [s[l][0], h]; else for (var c = s[0][0], l = 0; a > l; l++)r[l] = [c, s[l][1]];
                "half-smooth-polygon" == i.type && (r[a - 1] = f.clone(s[a - 1]), r[a - 2] = f.clone(s[a - 2])), e = {style: {pointList: r}}
            }
            r = e.style.pointList;
            var d = r.length;
            i.style.pointList = d == a ? r : a > d ? r.concat(s.slice(d)) : r.slice(0, a), t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {pointList: s}).during(function () {
        ...
        function o(t, e, o, n, r) {
            ...
            i(o, e, "x", "y", "width", "height"), o.position = e.position, t.addShape(o), (d[0] != e.position[0] || d[1] != e.position[1]) && t.animate(o.id, "").when(n, {position: d}).start(r), o.__animating = !0, t.animate(o.id, "style").when(n, {
                x: a,
                y: h,
                width: l,
                height: c
        ...
        function n(t, e, i, o, n) {
            ...
            var s = i.style.y;
            i.style.y = e.style.y, t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {y: s}).done(function () {
                i.__animating = !1
            }).start(n)
        }
        ...
        function r(t, e, i, o, n) {
            ...
            i.__animating = !0, "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, r, s], t.addShape(i), t.animate(i.id, "style").when(o, {
                r0: a,
                r: h
            }).done(function () {
                i.__animating = !1
            }).start(n), t.animate(i.id, "").when(o, {rotation: [0, r, s]}).start(n)) : (i.style.r0 = i.style.r, t.addShape(i), t.animate(i.id, "style").when(o, {r0: a}).done(function () {
                i.__animating = !1
            }).start(n))
        }
        ...
        function h(e, i, o, n, r) {
            ...
            o.scale = [.1, .1, a, h], e.addShape(o), o.__animating = !0, e.animate(o.id, "").when(n, {scale: [1, 1, a, h]}).done(function () {
                o.__animating = !1
            }).start(r)
        }
        ...
        function c(t, e, i, o, n) {
            ...
            var r = i.style.angle;
            i.style.angle = e.style.angle, t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {angle: r}).done(function () {
                i.__animating = !1
            }).start(n)
        }
        ...
        function d(t, e, i, n, r, s) {
            if (i.style._x = i.style.x, i.style._y = i.style.y, i.style._width = i.style.width, i.style._height = i.style.height, e)o(t, e, i, n, r); else {
                ...
                i.scale = [.01, .01, a, h], t.addShape(i), i.__animating = !0, t.animate(i.id, "").delay(s).when(n, {scale: [1, 1, a, h]}).done(function () {
                    i.__animating = !1
                }).start(r || "QuinticOut")
            }
        }
        ...
        function p(t, e, i, o, n) {
            ...
            var r = i.style, s = function () {
                i.__animating = !1
            }, a = r.xStart, h = r.yStart, l = r.xEnd, c = r.yEnd;
            if (r.curveness > 0) {
                i.updatePoints(r);
                var d = {p: 0}, u = r.cpX1, p = r.cpY1, f = [], m = [], _ = g.quadraticSubdivide;
                t.animation.animate(d).when(o, {p: 1}).during(function () {
                    _(a, u, l, d.p, f), _(h, p, c, d.p, m), r.cpX1 = f[1], r.cpY1 = m[1], r.xEnd = f[2], r.yEnd = m[2], t.modShape(i)
                }).done(s).start(n)
            } else t.animate(i.id, "style").when(0, {xEnd: a, yEnd: h}).when(o, {xEnd: l, yEnd: c}).done(s).start(n)
        }
        ...
        function e(t, e, n, r, s) {
            this.ecTheme = t, this.messageCenter = e, this.zr = n, this.option = r, this.series = r.series, this.myChart = s, this.component = s.component, this.shapeList = [], this.effectList = [];
            var a = this;
            a._onlegendhoverlink = function (t) {
                if (a.legendHoverLink)for (var e, n = t.target, r = a.shapeList.length - 1; r >= 0; r--)e = a.type == i.CHART_TYPE_PIE || a.type == i.CHART_TYPE_FUNNEL ? o.get(a.shapeList[r], "name") : (o.get(a.shapeList[r], "series") || {}).name, e != n || a.shapeList[r].invisible || a.shapeList[r].__animating || a.zr.addHoverShape(a.shapeList[r])
        ...
        function o(t, e, i, o) {
            ...
            switch (n) {
                ...
                case"polyline":
                    return c(e.pointList, e.lineWidth, i, o);
                case"ring":
                    return d(e.x, e.y, e.r0, e.r, i, o);
                case"circle":
        ...
        function h(t, e, i, o, n, r, s, a, h) {
            ...
            var c = E.quadraticProjectPoint(t, e, i, o, n, r, a, h, null);
            return l / 2 >= c
        }
        ...
        function l(t, i, o, n, r, s, a, h, l) {
            ...
            return 0 > p && (p += I), p >= n && r >= p || p + I >= n && r >= p + I
        }

        function c(t, e, i, o) {
            for (var e = Math.max(e, 10), n = 0, r = t.length - 1; r > n; n++) {
                var a = t[n][0], h = t[n][1], l = t[n + 1][0], c = t[n + 1][1];
                if (s(a, h, l, c, e, i, o))return !0
            }
            return !1
        }

        function d(t, e, i, o, n, r) {
        ...
        function g(t, e, i) {
            for (var o = t.length, n = 0, r = 0, s = o - 1; o > r; r++) {
                var a = t[s][0], h = t[s][1], l = t[r][0], c = t[r][1];
                n += m(a, h, l, c, e, i), s = r
            }
            return 0 !== n
        }
        ...
        function y(t, e, i, o, n, r, s, a, h, l) {
            ...
            var c = E.cubicRootAt(e, o, r, a, l, P);
            if (0 === c)return 0;
            for (var d, u, p = 0, f = -1, g = 0; c > g; g++) {
                var m = P[g], y = E.cubicAt(t, i, n, s, m);
                h > y || (0 > f && (f = E.cubicExtrema(e, o, r, a, O), O[1] < O[0] && f > 1 && _(), d = E.cubicAt(e, o, r, a, O[0]), f > 1 && (u = E.cubicAt(e, o, r, a, O[1]))), p += 2 == f ? m < O[0] ? e > d ? 1 : -1 : m < O[1] ? d > u ? 1 : -1 : u > a ? 1 : -1 : m < O[0] ? e > d ? 1 : -1 : d > a ? 1 : -1)
            }
            return p
        }
        ...
        function v(t, e, i, o, n, r, s, a) {
            ...
            var h = E.quadraticRootAt(e, o, r, a, P);
            if (0 === h)return 0;
            var l = E.quadraticExtremum(e, o, r);
            if (l >= 0 && 1 >= l) {
                for (var c = 0, d = E.quadraticAt(e, o, r, l), u = 0; h > u; u++) {
                    var p = E.quadraticAt(t, i, n, P[u]);
                    s > p || (c += P[u] < l ? e > d ? 1 : -1 : d > r ? 1 : -1)
                }
                return c
            }
            var p = E.quadraticAt(t, i, n, P[0]);
        ...
        function x(t, i, o, n, r, s, a, h) {
            ...
            for (var d = 0, u = 0; 2 > u; u++) {
                ...
                if (p + t > a) {
                    ...
                    0 > f && (f = I + f), (f >= n && r >= f || f + I >= n && r >= f + I) && (f > Math.PI / 2 && f < 1.5 * Math.PI && (c = -c), d += c)
                }
            }
            return d
        }
        ...
        function b(t, e, i, o, n) {
            var r = 0, c = 0, d = 0, u = 0, p = 0, f = !0, g = !0;
            i = i || "fill";
            for (var _ = "stroke" === i || "both" === i, b = "fill" === i || "both" === i, T = 0; T < t.length; T++) {
                var S = t[T], z = S.points;
                if (f || "M" === S.command) {
                    if (T > 0 && (b && (r += m(c, d, u, p, o, n)), 0 !== r))return !0;
                    u = z[z.length - 2], p = z[z.length - 1], f = !1, g && "A" !== S.command && (g = !1, c = u, d = p)
                }
                switch (S.command) {
                    case"M":
                        c = z[0], d = z[1];
                        break;
                    case"L":
                        if (_ && s(c, d, z[0], z[1], e, o, n))return !0;
                        b && (r += m(c, d, z[0], z[1], o, n)), c = z[0], d = z[1];
                        break;
                    case"C":
                        if (_ && a(c, d, z[0], z[1], z[2], z[3], z[4], z[5], e, o, n))return !0;
                        b && (r += y(c, d, z[0], z[1], z[2], z[3], z[4], z[5], o, n)), c = z[4], d = z[5];
                        break;
                    case"Q":
                        if (_ && h(c, d, z[0], z[1], z[2], z[3], e, o, n))return !0;
                        b && (r += v(c, d, z[0], z[1], z[2], z[3], o, n)), c = z[2], d = z[3];
                        break;
                    case"A":
                        var C = z[0], E = z[1], w = z[2], L = z[3], A = z[4], M = z[5], k = Math.cos(A) * w + C, I = Math.sin(A) * L + E;
                        g ? (g = !1, u = k, p = I) : r += m(c, d, k, I);
                        var P = (o - C) * L / w + C;
                        if (_ && l(C, E, L, A, A + M, 1 - z[7], e, P, n))return !0;
                        b && (r += x(C, E, L, A, A + M, 1 - z[7], P, n)), c = Math.cos(A + M) * w + C, d = Math.sin(A + M) * L + E;
                        break;
                    case"z":
                        if (_ && s(c, d, u, p, e, o, n))return !0;
                        f = !0
                }
            }
            return b && (r += m(c, d, u, p, o, n)), 0 !== r
        }
        ...
        function T(t, e) {
            ...
            return z.restore(), w[i] = o, ++A > k && (A = 0, w = {}), o
        }
        ...
        function S(t, e) {
            ...
            return z.restore(), L[i] = o, ++M > k && (M = 0, L = {}), o
        }

        var z, C = t("./util"), E = t("./curve"), w = {}, L = {}, A = 0, M = 0, k = 5e3, I = 2 * Math.PI, P = [-1, -1, -1], O = [-1, -1];
        return {
            isInside: i,
            isOutside: r,
            getTextWidth: T,
        ...
        function e(e, o, n, r, s, a, h) {
            ...
            for (var d = 0, u = o.length; u > d; d++)e.fillText(o[d], n, r), r += c
        }
        ...
        var o = window.G_vmlCanvasManager, n = t("../tool/matrix"), r = t("../tool/guid"), s = t("../tool/util"), a = t("../tool/log"), h = t("../mixin/Transformable"), l = t("../mixin/Eventful"), c = function (t) {
            t = t || {}, this.id = t.id || r();
        ...
        c.prototype.setContext = function (t, e) {
            for (var i = 0, o = d.length; o > i; i++) {
                var n = d[i][0], r = e[n], s = d[i][1];
        ...
        return c.prototype.doClip = function (t) {
        ...
        }, c.prototype.getHighlightStyle = function (e, i, o) {
            var n = {};
        ...
        }, c.prototype.drawText = function (t, i, o) {
            if ("undefined" != typeof i.text && i.text !== !1) {
                ...
                switch (c) {
                    ...
                    case"right":
                        if (this.getRect) {
                            var d = (o || i).__rect || this.getRect(o || i);
                            switch (c) {
                                case"inside":
                                    a = d.x + d.width / 2, h = d.y + d.height / 2, r = "center", s = "middle", "stroke" != i.brushType && n == i.color && (t.fillStyle = "#fff");
                                    break;
                                case"left":
        ...
        var d = function (i, o) {
            this.id = i, this.env = t("./tool/env"), this.storage = new a, this.painter = new s(o, this.storage), this.handler = new r(o, this.storage, this.painter), this.animation = new h({stage: {update: e(this)}}), this.animation.start();
            var n = this;
            this.painter.refreshNextFrame = function () {
                n.refreshNextFrame()
            }, this._needsRefreshNextFrame = !1;
            var n = this, l = this.storage, c = l.delFromMap;
            l.delFromMap = function (t) {
                var e = l.get(t);
                n.stopAnimation(e), c.call(l, t)
            }
        };
        return d.prototype.getId = function () {
        ...
        }, d.prototype.animate = function (t, e, n) {
            var r = this;
            if ("string" == typeof t && (t = this.storage.get(t)), t) {
                ...
                if (!s)return void o('Property "' + e + '" is not existed in element ' + t.id);
                null == t.__animators && (t.__animators = []);
                var d = t.__animators, u = this.animation.animate(s, {loop: n}).during(function () {
                    r.modShape(t)
                }).done(function () {
        ...
        function e(t, e) {
            t = t.array, e = e.array;
            var i = e[0] - t[0], o = e[1] - t[1], n = e[2] - t[2], r = e[3] - t[3];
            return i * i + o * o + n * n + r * r
        }
        ...
        return o.prototype.getStartPoint = function () {
            ...
            constructor: r, run: function (t) {
                function e(t, e) {
                    return l(t, e) < 1e-10
                }

                function o(t, i) {
                    for (var o = [], n = 0, r = 0; r < t.length; r++)n > 0 && e(t[r], o[n - 1]) || (o[n++] = u(t[r]));
                    return i[0] && !e(o[0], i[0]) && (o = o.reverse()), o
                }

                for (var n = this._iterate(t), r = 0; r++ < this.maxIteration;) {
                    for (var s = [], a = 0; a < n.groups.length; a++)s.push(new i(n.groups[a]));
                ...
                var c = [], d = function (t, e) {
                    for (var n, r = 0; r < t.length; r++) {
                        ...
                        if (s.edgeList[0] && s.edgeList[0].edge instanceof i) {
                            ...
                            n = e ? e.slice() : [], n.unshift(s.mp0), n.push(s.mp1), d(a, n)
                        } else for (var h = 0; h < s.edgeList.length; h++) {
                            var l = s.edgeList[h];
                            n = e ? e.slice() : [], n.unshift(s.mp0), n.push(s.mp1), n.unshift(l.getStartPoint()), n.push(l.getEndPoint()), c.push({
                ...
                for (var u = new s(i, 4), p = [], f = h(), g = h(), m = 0, _ = h(), y = h(), v = 0, l = 0; l < i.length; l++) {
                    ...
                    if (!c.group) {
                        ...
                        for (var x = 0, b = null, T = null, S = 0; S < p.length; S++) {
                            var z = p[S], C = 0;
                            z.group ? z.group !== T && (T = z.group, m = this._calculateGroupEdgeInk(z.group, c, f, g), C = z.group.ink + c.ink - m) : (m = this._calculateEdgeEdgeInk(c, z, f, g), C = z.ink + c.ink - m), C > x && (x = C, b = z, d(y, g), d(_, f), v = m)
                        }
                        if (b) {
                            a += x;
                            var E;
                            b.group || (E = new n, r.push(E), E.addEdge(b)), E = b.group, d(E.mp0, _), d(E.mp1, y), E.ink = v, b.group.addEdge(c)
                        } else {
                            var E = new n;
                ...
                return {groups: r, edges: i, savedInk: a}
            }, _calculateEdgeEdgeInk: function () {
                var t = [], e = [];
                return function (i, o, n, r) {
                    t[0] = i.getStartPoint(), t[1] = o.getStartPoint(), e[0] = i.getEndPoint(), e[1] = o.getEndPoint(), this._calculateMeetPoints(t, e, n, r);
                    var s = c(t[0], n) + c(n, r) + c(r, e[0]) + c(t[1], n) + c(r, e[1]);
                    return s
                }
            }(), _calculateGroupEdgeInk: function (t, e, i, o) {
                for (var n = [], r = [], s = 0; s < t.edgeList.length; s++) {
                    var a = t.edgeList[s];
                    n.push(a.getStartPoint()), r.push(a.getEndPoint())
                }
                n.push(e.getStartPoint()), r.push(e.getEndPoint()), this._calculateMeetPoints(n, r, i, o);
                for (var h = c(i, o), s = 0; s < n.length; s++)h += c(n[s], i) + c(r[s], o);
                return h
                ...
                return function (i, o, n, r) {
                    ...
                    a.scale(t, t, 1 / s), s = o.length;
                    for (var h = 0; s > h; h++)a.add(e, e, o[h]);
                    a.scale(e, e, 1 / s), this._limitTurningAngle(i, t, e, n), this._limitTurningAngle(o, e, t, r)
                }
            }(), _limitTurningAngle: function () {
                var t = h(), e = h(), i = h(), o = h();
                return function (n, r, s, h) {
                    ...
                    for (var p = 0, f = 0; f < n.length; f++) {
                        ...
                        var _ = a.dot(e, t);
                        if (d > _) {
                            a.scaleAndAdd(i, r, t, m * _);
                            var y = c(i, g), v = y / u;
                            a.scaleAndAdd(o, i, t, -v);
                            var x = l(o, r);
                            x > p && (p = x, a.copy(h, o))
                        }
                    }
        ...
        function e(t, e, i, o) {
            var n, s = i.effect, h = s.color || i.style.strokeColor || i.style.color, c = s.shadowColor || h, d = s.scaleSize, u = s.bounceDistance, p = "undefined" != typeof s.shadowBlur ? s.shadowBlur : d;
            "image" !== i.type ? (n = new l({
                ...
                draggable: !1,
                hoverable: !1
            }), "pin" == i.style.iconType && (n.style.y += n.style.height / 2 * 1.5), f && (n.style.image = t.shapeToImage(n, n.style.width + 2 * p + 2, n.style.height + 2 * p + 2).style.image, n = new a({
                zlevel: n.zlevel,
                style: n.style,
                draggable: !1,
                hoverable: !1
                ...
                draggable: !1,
                hoverable: !1
            }), r.clone(i, n), n.position = i.position, e.push(n), t.addShape(n);
            var g = "image" !== i.type ? window.devicePixelRatio || 1 : 1, m = (n.style.width / g - i.style._width) / 2;
            ...
            var y = n.style.x + n.style.width / 2 / g, v = n.style.y + n.style.height / 2 / g;
            "scale" === s.type ? (t.modShape(n.id, {scale: [.1, .1, y, v]}), t.animate(n.id, "", s.loop).when(_, {scale: [1, 1, y, v]}).done(function () {
                i.effect.show = !1, t.delShape(n.id)
            }).start()) : t.animate(n.id, "style", s.loop).when(_, {y: n.style.y - u}).when(2 * _, {y: n.style.y}).done(function () {
                i.effect.show = !1, t.delShape(n.id)
            }).start()
        }

        function i(t, e, i, o) {
            var n = i.effect, r = n.color || i.style.strokeColor || i.style.color, s = n.scaleSize, a = n.shadowColor || r, h = "undefined" != typeof n.shadowBlur ? n.shadowBlur : 2 * s, l = window.devicePixelRatio || 1, d = new c({
                zlevel: o,
                position: i.position,
                scale: i.scale,
                style: {
            ...
            for (var u = Math.round(100 * n.period), p = {}, f = {}, g = 0; 20 > g; g++)d.style["randomMap" + g] = 0, p = {}, p["randomMap" + g] = 100, f = {}, f["randomMap" + g] = 0, d.style["randomMap" + g] = 100 * Math.random(), t.animate(d.id, "style", !0).when(u, p).when(2 * u, f).when(3 * u, p).when(4 * u, p).delay(Math.random() * u * g).start()
        }
        ...
        function o(t, e, i, o, n) {
            ...
            if (f && !n) {
                var o = _.zlevel;
                _ = t.shapeToImage(_, 2 * (g + m), 2 * (g + m)), _.zlevel = o, _.hoverable = !1, y = m
            }
            n || (r.clone(i, _), _.position = i.position, e.push(_), t.addShape(_));
            var v = function () {
                n || (i.effect.show = !1, t.delShape(_.id)), _.effectAnimator = null
            };
            if (i instanceof u) {
                for (var x = [0], b = 0, T = l.pointList, S = l.controlPointList, z = 1; z < T.length; z++) {
                    if (S) {
                        var C = S[2 * (z - 1)], E = S[2 * (z - 1) + 1];
                        b += p.dist(T[z - 1], C) + p.dist(C, E) + p.dist(E, T[z])
                    } else b += p.dist(T[z - 1], T[z]);
                    x.push(b)
                }
                for (var w = {p: 0}, L = t.animation.animate(w, {loop: a.loop}), z = 0; z < x.length; z++)L.when(x[z] * a.period, {p: z});
                L.during(function () {
                    var e, i, o = Math.floor(w.p);
                    if (o == T.length - 1)e = T[o][0], i = T[o][1]; else {
                        var r = w.p - o, s = T[o], a = T[o + 1];
                        if (S) {
                            var l = S[2 * o], c = S[2 * o + 1];
                ...
                }).done(v).start(), L.duration = b * a.period, _.effectAnimator = L
            } else {
                var A = l.xStart - y, M = l.yStart - y, k = l.xEnd - y, I = l.yEnd - y;
                _.style.x = A, _.style.y = M;
                var P = (k - A) * (k - A) + (I - M) * (I - M), O = Math.round(Math.sqrt(Math.round(P * a.period * a.period)));
                if (i.style.curveness > 0) {
                    var D = l.cpX1 - y, R = l.cpY1 - y;
                    _.effectAnimator = t.animation.animate(_, {loop: a.loop}).when(O, {p: 1}).during(function (e, i) {
                        _.style.x = h.quadraticAt(A, D, k, i), _.style.y = h.quadraticAt(M, R, I, i), n || t.modShape(_)
                    }).done(v).start()
        ...
        function n(t, e, i, n) {
            var r = new d({style: {shapeList: []}, zlevel: n, hoverable: !1}), s = i.style.shapeList, a = i.effect;
            r.position = i.position;
            for (var h = 0, l = [], c = 0; c < s.length; c++) {
                s[c].effect = a;
                var u = o(t, null, s[c], n, !0), p = u.effectAnimator;
            ...
            if (h) {
                r.__dummy = 0;
                var g = t.animate(r.id, "", a.loop).when(h, {__dummy: 1}).during(function () {
                    t.modShape(r)
                }).done(function () {
        ...
        var r = t("../util/ecData"), s = t("zrender/shape/Circle"), a = t("zrender/shape/Image"), h = t("zrender/tool/curve"), l = t("../util/shape/Icon"), c = t("../util/shape/Symbol"), d = t("zrender/shape/ShapeBundle"), u = t("zrender/shape/Polyline"), p = t("zrender/tool/vector"), f = t("zrender/tool/env").canvasSupported;
        ...
        var i = t("./base"), o = t("zrender/shape/Line"), n = t("zrender/shape/Image"), r = t("zrender/shape/Rectangle"), s = t("../util/shape/Icon"), a = t("../config");
        a.toolbox = {
            zlevel: 0,
            z: 6,
            show: !1,
        ...
        return e.prototype = {
            type: a.COMPONENT_TYPE_TOOLBOX, _buildShape: function () {
                ...
                var e, i, o, r, a = this.option.toolbox, h = this._iconList.length, l = this._itemGroupLocation.x, c = this._itemGroupLocation.y, d = a.itemSize, u = a.itemGap, p = a.color instanceof Array ? a.color : [a.color], f = this.getFont(a.textStyle);
                ...
                for (var g = this, m = 0; h > m; m++) {
                    ...
                    "icon" === e.type ? e = new s(e) : "image" === e.type && (e = new n(e)), this.shapeList.push(e), this._iconShapeMap[this._iconList[m]] = e, "horizontal" === a.orient ? l += d + u : c += d + u
                }
            }, _buildBackground: function () {
                ...
                if (this._defaultMagic(a.CHART_TYPE_CHORD, a.CHART_TYPE_FORCE), this._defaultMagic(a.CHART_TYPE_PIE, a.CHART_TYPE_FUNNEL), this._magicType[d] || this._magicType[u])for (var o = 0, n = this.option.series.length; n > o; o++)this._magicType[d] ? (this.option.series[o].stack = "_ECHARTS_STACK_KENER_2014_", e = d) : this._magicType[u] && (this.option.series[o].stack = null, e = u), this._featureOption[e + "Chart"] && h.merge(this.option.series[o], this._featureOption[e + "Chart"] || {}, !0);
                return this.option
        ...
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this._nameConnector, this._valueConnector, this._zrHeight = this.zr.getHeight(), this._zrWidth = this.zr.getWidth();
            var h = this;
            h.shapeHandler.onmousewheel = function (t) {
                var e = t.target, i = t.event, o = a.getDelta(i);
                ...
                var l = r.get(e, "name");
                e.style.text = l + ":" + n, r.set(e, "value", n), r.set(e, "name", l), h.zr.modShape(e.id), h.zr.refreshNextFrame(), a.stop(i)
            }
        }

        var i = t("./base"), o = t("zrender/shape/Circle"), n = t("../config");
        n.island = {zlevel: 0, z: 5, r: 15, calculateStep: .1};
        var r = t("../util/ecData"), s = t("zrender/tool/util"), a = t("zrender/tool/event");
        return e.prototype = {
            type: n.CHART_TYPE_ISLAND, _combine: function (e, i) {
                var o = t("zrender/tool/color"), n = t("../util/accMath"), s = n.accAdd(r.get(e, "value"), r.get(i, "value")), a = r.get(e, "name") + this._nameConnector + r.get(i, "name");
                e.style.text = a + this._valueConnector + s, r.set(e, "value", s), r.set(e, "name", a), e.style.r = this.option.island.r, e.style.color = o.mix(e.style.color, i.style.color)
            }, refresh: function (t) {
                ...
                var e = r.get(t, "name"), i = r.get(t, "value"), n = null != r.get(t, "series") ? r.get(t, "series").name : "", s = this.getFont(this.option.island.textStyle), a = this.option.island, h = {
                    zlevel: a.zlevel,
                    z: a.z,
                    style: {
                        x: t.style.x,
                ...
                "#fff" === h.style.color && (h.style.color = t.style.strokeColor), this.setCalculable(h), h.dragEnableTime = 0, r.pack(h, {name: n}, -1, i, -1, e), h = new o(h), this.shapeList.push(h), this.zr.addShape(h)
            }, del: function (t) {
        ...
        var i = t("./base"), o = t("zrender/shape/Text"), n = t("zrender/shape/Rectangle"), r = t("../config");
        r.title = {
            zlevel: 0,
            z: 6,
            show: !0,
        ...
        return e.prototype = {
            type: r.COMPONENT_TYPE_TITLE, _buildShape: function () {
                ...
                var t = this.titleOption.text, e = this.titleOption.link, i = this.titleOption.target, n = this.titleOption.subtext, r = this.titleOption.sublink, s = this.titleOption.subtarget, a = this.getFont(this.titleOption.textStyle), l = this.getFont(this.titleOption.subtextStyle), c = this._itemGroupLocation.x, d = this._itemGroupLocation.y, u = this._itemGroupLocation.width, p = this._itemGroupLocation.height, f = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
        ...
        var i = t("./base"), o = t("../util/shape/Cross"), n = t("zrender/shape/Line"), r = t("zrender/shape/Rectangle"), s = new r({}), a = t("../config");
        a.tooltip = {
            zlevel: 1,
            z: 8,
            show: !0,
        ...
        return e.prototype = {
            ...
            _getNearestDataIndex: function (t, e) {
                var i = -1, o = c.getX(this._event), n = c.getY(this._event);
                if ("x" === t) {
                ...
                for (var l, d, u = this.component.grid.getY(), h = e.getCoordByIndex(i); h > u && (l = h, h >= n);)d = h, h = e.getCoordByIndex(++i);
                return 0 >= i ? i = 0 : n - l >= d - n ? i -= 1 : null == e.getNameByIndex(i) && (i -= 1), i
            },
            ...
            _showPolarTrigger: function (t, e) {
                ...
                if (s.length > 0) {
                    ...
                    return this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(o, c.getX(this._event), c.getY(this._event), h), !0
                }
            },
            _showItemTrigger: function (t) {
                if (this._curTarget) {
                    var e, i, o, n = h.get(this._curTarget, "series"), r = h.get(this._curTarget, "seriesIndex"), s = h.get(this._curTarget, "data"), l = h.get(this._curTarget, "dataIndex"), d = h.get(this._curTarget, "name"), u = h.get(this._curTarget, "value"), p = h.get(this._curTarget, "special"), f = h.get(this._curTarget, "special2"), g = [s, n, this.option], m = "";
                    if ("island" != this._curTarget._type) {
                        var _ = t ? "axis" : "item";
                        this.option.tooltip.trigger === _ && (e = this.option.tooltip.formatter, i = this.option.tooltip.position), this.query(n, "tooltip.trigger") === _ && (o = this.query(n, "tooltip.showContent") || o, e = this.query(n, "tooltip.formatter") || e, i = this.query(n, "tooltip.position") || i, m += this._style(this.query(n, "tooltip"))), o = this.query(s, "tooltip.showContent") || o, e = this.query(s, "tooltip.formatter") || e, i = this.query(s, "tooltip.position") || i, m += this._style(this.query(s, "tooltip"))
                    } else this._lastItemTriggerId = 0 / 0, o = this.deepQuery(g, "tooltip.showContent"), e = this.deepQuery(g, "tooltip.islandFormatter"), i = this.deepQuery(g, "tooltip.islandPosition");
            ...
            __onmousemove: function (t) {
                if (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), !this._mousein || !this._enterable) {
                    var e = t.target, i = c.getX(t.event), o = c.getY(t.event);
                    if (e) {
                    ...
                    } else this._curTarget = !1, this._event = t.event, this._event.zrenderX = i, this._event.zrenderY = o, this._needAxisTrigger && this.component.grid && d.isInside(s, this.component.grid.getArea(), i, o) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, o]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(a.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart), this._hidingTicket = setTimeout(this._hide, this._hideDelay))
                }
            },
                        ...
                        if (c)if (d) {
                            ...
                            switch (c.type) {
                                ...
                                case a.CHART_TYPE_SCATTER:
                                    for (var u = t.dataIndex, n = 0, r = _.length; r > n; n++)if (null == _[n]._mark && h.get(_[n], "seriesIndex") == e && h.get(_[n], "dataIndex") == u) {
                                        this._curTarget = _[n], g = _[n].style.x, m = c.type != a.CHART_TYPE_K ? _[n].style.y : _[n].style.y[0];
                                        break
                                    }
                                    break;
                                case a.CHART_TYPE_RADAR:
                                    for (var u = t.dataIndex, n = 0, r = _.length; r > n; n++)if ("polygon" === _[n].type && h.get(_[n], "seriesIndex") == e && h.get(_[n], "dataIndex") == u) {
                                        this._curTarget = _[n];
                                ...
                                case a.CHART_TYPE_PIE:
                                    for (var y = t.name, n = 0, r = _.length; r > n; n++)if ("sector" === _[n].type && h.get(_[n], "seriesIndex") == e && h.get(_[n], "name") == y) {
                                        this._curTarget = _[n];
                                ...
                                case a.CHART_TYPE_MAP:
                                    for (var y = t.name, b = s.mapType, n = 0, r = _.length; r > n; n++)if ("text" === _[n].type && _[n]._mapType === b && _[n].style._name === y) {
                                        this._curTarget = _[n], g = this._curTarget.style.x + this._curTarget.position[0], m = this._curTarget.style.y + this._curTarget.position[1];
                                        break
                                    }
                                    break;
                                case a.CHART_TYPE_CHORD:
                                    for (var y = t.name, n = 0, r = _.length; r > n; n++)if ("sector" === _[n].type && h.get(_[n], "name") == y) {
                                        this._curTarget = _[n];
                                        var v = this._curTarget.style, x = (v.startAngle + v.endAngle) / 2 * Math.PI / 180;
                                ...
                                case a.CHART_TYPE_FORCE:
                                    for (var y = t.name, n = 0, r = _.length; r > n; n++)if ("circle" === _[n].type && h.get(_[n], "name") == y) {
                                        this._curTarget = _[n], g = this._curTarget.position[0], m = this._curTarget.position[1];
                                        break
                                    }
                            }
        ...
        var i = t("./base"), o = t("zrender/shape/Text"), n = t("zrender/shape/Rectangle"), r = t("zrender/shape/Sector"), s = t("../util/shape/Icon"), a = t("../util/shape/Candle"), h = t("../config");
        h.legend = {
            zlevel: 0,
            z: 4,
            show: !0,
        ...
        e.prototype = {
            type: h.COMPONENT_TYPE_LEGEND, _buildShape: function () {
                ...
                for (var t = [], e = this._itemGroupLocation.x, i = 2, o = this.shapeList.length; o > i; i++)this.shapeList[i].style.x === e ? t.push((this._itemGroupLocation.width - (this.shapeList[i - 1].style.x + c.getTextWidth(this.shapeList[i - 1].style.text, this.shapeList[i - 1].style.textFont) - e)) / 2) : i === o - 1 && t.push((this._itemGroupLocation.width - (this.shapeList[i].style.x + c.getTextWidth(this.shapeList[i].style.text, this.shapeList[i].style.textFont) - e)) / 2);
                ...
                var t = this.legendOption.data, e = t.length, i = this.legendOption.itemGap, o = this.legendOption.itemWidth + 5, n = this.legendOption.itemHeight, r = this.legendOption.textStyle, s = this.getFont(r), a = 0, h = 0, d = this.reformCssArray(this.legendOption.padding), u = this.zr.getWidth() - d[1] - d[3], p = this.zr.getHeight() - d[0] - d[2], f = 0, g = 0;
                if ("horizontal" === this.legendOption.orient) {
                    h = n;
                    for (var m = 0; e > m; m++)if ("" !== this._getName(t[m])) {
                        var _ = c.getTextWidth(this._getFormatterNameFromData(t[m]), t[m].textStyle ? this.getFont(l.merge(t[m].textStyle || {}, r)) : s);
                        f + o + _ + i > u ? (f -= i, a = Math.max(a, f), h += n + i, f = 0) : (f += o + _ + i, a = Math.max(a, f - i))
                    } else f -= i, a = Math.max(a, f), h += n + i, f = 0
                } else {
                    ...
                    g += o, a = g;
                    for (var m = 0; e > m; m++)"" !== this._getName(t[m]) ? f + n + i > p ? (a += g + i, f -= i, h = Math.max(h, f), f = 0) : (f += n + i, h = Math.max(h, f - i)) : (a += g + i, f -= i, h = Math.max(h, f), f = 0)
                }
                ...
                switch (r) {
                    ...
                    case"scatter":
                        ...
                        break;
                    case"k":
                        c.style.brushType = "both", c.highlightStyle.lineWidth = 3, c.highlightStyle.color = c.style.color = this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.color") || "#fff", c.style.strokeColor = "#ccc" != n ? this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.lineStyle.color") || "#ff3200" : n;
                        break;
                    case"image":
                        c.style.iconType = "image", c.style.image = a, "#ccc" === n && (c.style.opacity = .5)
                }
                return c
        ...
        var d = {
            line: function (t, e) {
                ...
                r.prototype.buildPath(t, {x: i + n / 2, y: o + s + 2, r: s, r0: 6, startAngle: 45, endAngle: 135})
        ...
        function i(t, e) {
            ...
            if ("last" === h)t.moveTo(o + s - 2, n + a / 3), t.lineTo(o + s - 2, n), t.lineTo(o + 2, n + a / 2), t.lineTo(o + s - 2, n + a), t.lineTo(o + s - 2, n + a / 3 * 2), t.moveTo(o, n), t.lineTo(o, n); else if ("next" === h)t.moveTo(o + 2, n + a / 3), t.lineTo(o + 2, n), t.lineTo(o + s - 2, n + a / 2), t.lineTo(o + 2, n + a), t.lineTo(o + 2, n + a / 3 * 2), t.moveTo(o, n), t.lineTo(o, n); else if ("play" === h)if ("stop" === e.status)t.moveTo(o + 2, n), t.lineTo(o + s - 2, n + a / 2), t.lineTo(o + 2, n + a), t.lineTo(o + 2, n); else {
                ...
                var c = "";
                c = h.replace(new RegExp("^image:\\/\\/"), ""), h = r.prototype.iconLibrary.image, h(t, {
                    x: o,
                    y: n,
                    width: s,
                    height: a,
        ...
        var o = t("./base"), n = t("zrender/shape/Rectangle"), r = t("../util/shape/Icon"), s = t("../util/shape/Chain"), a = t("../config");
        a.timeline = {
            zlevel: 0,
            z: 4,
            show: !0,
        ...
        return e.prototype = {
            type: a.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
                ...
                if ("auto" === i) {
                    ...
                    if (r > 3) {
                        ...
                        for (i = 0; !h && r > i;) {
                            i++, h = !0;
                            for (var c = i; r > c; c += i) {
                                if (s = t[c].x - t[c - i].x, 0 !== e.label.rotate)a = o; else if (n[c].textStyle)a = l.getTextWidth(t[c].name, t[c].textFont); else {
                ...
                var e, i = this.timelineOption, o = i.symbol.toLowerCase(), n = i.symbolSize, r = i.label.rotate, s = i.label.textStyle, a = this.getFont(s), l = i.data, c = this._location.x, d = this._location.y + this._location.height / 4 * 3, u = this._location.x2 - this._location.x, p = l.length, f = [];
                if (p > 1) {
                    var g = u / p;
                ...
                for (var _, y, v, x, b, T = [], m = 0; p > m; m++)c = f[m], _ = l[m].symbol && l[m].symbol.toLowerCase() || o, _.match("empty") ? (_ = _.replace("empty", ""), v = !0) : v = !1, _.match("star") && (y = _.replace("star", "") - 0 || 5, _ = "star"), e = l[m].textStyle ? h.merge(l[m].textStyle || {}, s) : s, x = e.align || "center", r ? (x = r > 0 ? "right" : "left", b = [r * Math.PI / 180, c, d - 5]) : b = !1, T.push({
                    x: c,
                    n: y,
                    isEmpty: v,
                    symbol: _,
                ...
                if ("none" !== e.controlPosition) {
                    var n, s = o.itemSize, a = o.itemGap;
                    ...
                    this._ctrLastShape = new r(c), this._ctrLastShape.onclick = function () {
                        t.last()
                    }, this.shapeList.push(this._ctrLastShape), n += s + a, this._ctrPlayShape = new r(h.clone(c)), this._ctrPlayShape.style.brushType = "fill", this._ctrPlayShape.style.symbol = "play", this._ctrPlayShape.style.status = this.timelineOption.autoPlay ? "playing" : "stop", this._ctrPlayShape.style.x = n, this._ctrPlayShape.onclick = function () {
                        "stop" === t._ctrPlayShape.style.status ? t.play() : t.stop()
                    }, this.shapeList.push(this._ctrPlayShape), n += s + a, this._ctrNextShape = new r(h.clone(c)), this._ctrNextShape.style.symbol = "next", this._ctrNextShape.style.x = n, this._ctrNextShape.onclick = function () {
                        t.next()
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            ...
            return setInterval(function () {
                t(a);
                for (var i = 0; l > i; i++) {
                    var o = d[i].highlightStyle;
                    o.xStart >= u && (d[i].len = Math.ceil(400 * Math.random()), o.xStart = -400, o.xEnd = -400 + d[i].len, o.yStart = Math.ceil(Math.random() * p), o.yEnd = o.yStart), o.xStart += d[i].animationX, o.xEnd += d[i].animationX, t(d[i])
                }
                t(s), e()
            }, h.timeInterval)
        }, e
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            ...
            for (var l = this.createTextShape(i.textStyle), c = this.createBackgroundShape(i.backgroundColor), d = a.x, u = a.y, p = a.r0 + 6, f = a.r - 6, g = a.color, m = n.lift(g, .1), _ = new r({highlightStyle: o.clone(a)}), y = [], v = n.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), x = 15, b = 240, T = 0; 16 > T; T++)y.push(new s({
                highlightStyle: {
                    x: d,
                    y: u,
                    r0: p,
                ...
                _color: n.getLinearGradient(d + p * Math.cos(b, !0), u - p * Math.sin(b, !0), d + p * Math.cos(b - x, !0), u - p * Math.sin(b - x, !0), [[0, v[2 * T]], [1, v[2 * T + 1]]])
            })), b -= x;
            b = 360;
            for (var T = 0; 4 > T; T++)y.push(new s({
                ...
                _color: n.getLinearGradient(d + p * Math.cos(b, !0), u - p * Math.sin(b, !0), d + p * Math.cos(b - x, !0), u - p * Math.sin(b - x, !0), [[0, v[2 * T + 32]], [1, v[2 * T + 33]]])
            })), b -= x;
            var S = 0;
            if (null != i.progress) {
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            var i = o.merge(this.options, {
                ...
                backgroundColor: "rgba(250, 250, 250, 0.8)"
            }), h = this.createTextShape(i.textStyle), l = 10, c = n.getTextWidth(h.highlightStyle.text, h.highlightStyle.textFont), d = n.getTextHeight(h.highlightStyle.text, h.highlightStyle.textFont), u = o.merge(this.options.effect || {}, {
                r: 18,
                colorIn: "#fff",
                colorOut: "#555",
                colorWhirl: "#6cf",
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            var i = o.merge(this.options, {
                ...
                backgroundColor: "rgba(0, 0, 0, 0.8)"
            }), a = this.createTextShape(i.textStyle), h = 10, l = r.getTextWidth(a.highlightStyle.text, a.highlightStyle.textFont), c = r.getTextHeight(a.highlightStyle.text, a.highlightStyle.textFont), d = o.merge(this.options.effect || {}, {
                r0: 9,
                r: 15,
                n: 18,
                color: "#fff",
        ...
        return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function () {
            ...
            function p(t) {
                var e, i, o, n, r, s;
                if (n = parseFloat(t[0]) / 360 % 360, 0 > n && n++, r = u(d(t[1]), 0, 1), s = u(d(t[2]), 0, 1), 0 == r)e = i = o = s; else {
            ...
            function g(t) {
                ...
                if (t = String(t), "#" == t.charAt(0))e = t; else if (/^rgb/.test(t)) {
                    for (var o, n = c(t), e = "#", r = 0; 3 > r; r++)o = -1 != n[r].indexOf("%") ? Math.floor(255 * d(n[r])) : +n[r], e += W[u(o, 0, 255)];
                    i = +n[3]
                } else if (/^hsl/.test(t)) {
                    var n = c(t);
                    e = p(n), i = n[3]
            ...
            function S(t, e, i, o) {
                ...
                if (n instanceof w) {
                    ...
                    if ("gradient" == n.type_) {
                        var p = n.x0_ / r, f = n.y0_ / s, m = n.x1_ / r, _ = n.y1_ / s, y = z(t, p, f), v = z(t, m, _), x = v.x - y.x, b = v.y - y.y;
                        l = 180 * Math.atan2(x, b) / Math.PI, 0 > l && (l += 360), 1e-6 > l && (l = 0)
                    } else {
                        var y = z(t, n.x0_, n.y0_);
                        c = {x: (y.x - i.x) / a, y: (y.y - i.y) / h}, a /= r * B, h /= s * B;
                        var T = I.max(a, h);
                        d = 2 * n.r0_ / T, u = 2 * n.r1_ / T - d
                    }
                    var S = n.colors_;
                    S.sort(function (t, e) {
                        return t.offset - e.offset
                    });
                    for (var C = S.length, E = S[0].color, A = S[C - 1].color, M = S[0].alpha * t.globalAlpha, k = S[C - 1].alpha * t.globalAlpha, P = [], O = 0; C > O; O++) {
                        var D = S[O];
                        P.push(D.offset * u + d + " " + D.color)
                    }
                    e.push('<g_vml_:fill type="', n.type_, '"', ' method="none" focus="100%"', ' color="', E, '"', ' color2="', A, '"', ' colors="', P.join(","), '"', ' opacity="', k, '"', ' g_o_:opacity2="', M, '"', ' angle="', l, '"', ' focusposition="', c.x, ",", c.y, '" />')
                } else if (n instanceof L) {
                    if (a && h) {
                        var R = -i.x, H = -i.y;
                        e.push("<g_vml_:fill", ' position="', R / a * r * r, ",", H / h * s * s, '"', ' type="tile"', ' src="', n.src_, '" />')
                    }
                } else {
                    var F = g(t.fillStyle), N = F.color, Y = F.alpha * t.globalAlpha;
                    e.push('<g_vml_:fill color="', N, '" opacity="', Y, '" />')
                }
            }
            ...
            function z(t, e, i) {
                var o = t.m_;
                return {
                    x: B * (e * o[0][0] + i * o[1][0] + o[2][0]) - F,
                    y: B * (e * o[0][1] + i * o[1][1] + o[2][1]) - F
                }
            }
            ...
            var I = Math, P = I.round, O = I.sin, D = I.cos, R = I.abs, H = I.sqrt, B = 10, F = B / 2, N = (+navigator.userAgent.match(/MSIE ([\d.]+)?/)[1], Array.prototype.slice);
            n(document);
            var Y = {
                init: function (t) {
                    var i = t || document;
            ...
            Y.init();
            for (var W = [], q = 0; 16 > q; q++)for (var X = 0; 16 > X; X++)W[16 * q + X] = q.toString(16) + X.toString(16);
            var G = {
                aliceblue: "#F0F8FF",
                antiquewhite: "#FAEBD7",
                aquamarine: "#7FFFD4",
                ...
                size: 12,
                family: "微软雅黑"
            }, U = {}, Q = {butt: "flat", round: "round"}, K = x.prototype;
            K.clearRect = function () {
                ...
                this.currentPath_ = []
            }, K.moveTo = function (t, e) {
                var i = z(this, t, e);
                this.currentPath_.push({type: "moveTo", x: i.x, y: i.y}), this.currentX_ = i.x, this.currentY_ = i.y
            }, K.lineTo = function (t, e) {
                var i = z(this, t, e);
                this.currentPath_.push({type: "lineTo", x: i.x, y: i.y}), this.currentX_ = i.x, this.currentY_ = i.y
            }, K.bezierCurveTo = function (t, e, i, o, n, r) {
                var s = z(this, n, r), a = z(this, t, e), h = z(this, i, o);
                b(this, a, h, s)
            }, K.quadraticCurveTo = function (t, e, i, o) {
                var n = z(this, t, e), r = z(this, i, o), s = {
                ...
                b(this, s, a, r)
            }, K.arc = function (t, e, i, o, n, r) {
                i *= B;
                var s = r ? "at" : "wa", a = t + D(o) * i - F, h = e + O(o) * i - F, l = t + D(n) * i - F, c = e + O(n) * i - F;
                a != l || r || (a += .125);
            ...
            }, K.createLinearGradient = function (t, e, i, o) {
                var n = new w("gradient");
                return n.x0_ = t, n.y0_ = e, n.x1_ = i, n.y1_ = o, n
            }, K.createRadialGradient = function (t, e, i, o, n, r) {
                var s = new w("gradientradial");
                return s.x0_ = t, s.y0_ = e, s.r0_ = i, s.x1_ = o, s.y1_ = n, s.r1_ = r, s
            }, K.drawImage = function (t) {
                var e, i, o, n, r, s, a, h, l = t.runtimeStyle.width, c = t.runtimeStyle.height;
                t.runtimeStyle.width = "auto", t.runtimeStyle.height = "auto";
                var d = t.width, u = t.height;
                if (t.runtimeStyle.width = l, t.runtimeStyle.height = c, 3 == arguments.length)e = arguments[1], i = arguments[2], r = s = 0, a = o = d, h = n = u; else if (5 == arguments.length)e = arguments[1], i = arguments[2], o = arguments[3], n = arguments[4], r = s = 0, a = d, h = u; else {
                ...
                var p = z(this, e, i), f = [], g = 10, m = 10, _ = v = 1;
                if (f.push(" <g_vml_:group", ' coordsize="', B * g, ",", B * m, '"', ' coordorigin="0,0"', ' style="width:', g, "px;height:", m, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                    ...
                    y.push("M11=", this.m_[0][0] / _, ",", "M12=", this.m_[1][0] / v, ",", "M21=", this.m_[0][1] / _, ",", "M22=", this.m_[1][1] / v, ",", "Dx=", P(p.x / B), ",", "Dy=", P(p.y / B), "");
                    var x = p, b = z(this, e + o, i), T = z(this, e, i + n), S = z(this, e + o, i + n);
                    x.x = I.max(x.x, b.x, T.x, S.x), x.y = I.max(x.y, b.y, T.y, S.y), f.push("padding:0 ", P(x.x / B), "px ", P(x.y / B), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
                } else f.push("top:", P(p.y / B), "px;left:", P(p.x / B), "px;");
                ...
                var e = D(t), i = O(t), o = [[e, i, 0], [-i, e, 0], [0, 0, 1]];
                E(this, h(o, this.m_), !1)
            }, K.scale = function (t, e) {
                var i = [[t, 0, 0], [0, e, 0], [0, 0, 1]];
                E(this, h(i, this.m_), !0)
            }, K.transform = function (t, e, i, o, n, r) {
                var s = [[t, e, 0], [i, o, 0], [n, r, 1]];
                E(this, h(s, this.m_), !0)
            }, K.setTransform = function (t, e, i, o, n, r) {
                var s = [[t, e, 0], [i, o, 0], [n, r, 1]];
                E(this, s, !0)
            }, K.drawText_ = function (t, e, o, n, r) {
                ...
                var x = s[0][0].toFixed(3) + "," + s[1][0].toFixed(3) + "," + s[0][1].toFixed(3) + "," + s[1][1].toFixed(3) + ",0,0", b = P(v.x / B) + "," + P(v.y / B);
            ...
            }, K.fillText = function (t, e, i, o) {
                this.drawText_(t, e, i, o, !1)
            }, K.strokeText = function (t, e, i, o) {
                this.drawText_(t, e, i, o, !0)
            }, K.measureText = function (t) {
            ...
            }, K.createPattern = function (t, e) {
                return new L(t, e)
            }, w.prototype.addColorStop = function (t, e) {
                e = g(e), this.colors_.push({offset: t, color: e.color, alpha: e.alpha})
            };
            var j = k.prototype = new Error;
            j.INDEX_SIZE_ERR = 1, j.DOMSTRING_SIZE_ERR = 2, j.HIERARCHY_REQUEST_ERR = 3, j.WRONG_DOCUMENT_ERR = 4, j.INVALID_CHARACTER_ERR = 5, j.NO_DATA_ALLOWED_ERR = 6, j.NO_MODIFICATION_ALLOWED_ERR = 7, j.NOT_FOUND_ERR = 8, j.NOT_SUPPORTED_ERR = 9, j.INUSE_ATTRIBUTE_ERR = 10, j.INVALID_STATE_ERR = 11, j.SYNTAX_ERR = 12, j.INVALID_MODIFICATION_ERR = 13, j.NAMESPACE_ERR = 14, j.INVALID_ACCESS_ERR = 15, j.VALIDATION_ERR = 16, j.TYPE_MISMATCH_ERR = 17, G_vmlCanvasManager = Y, CanvasRenderingContext2D = x, CanvasGradient = w, CanvasPattern = L, DOMException = k
        }(), G_vmlCanvasManager
        ...
        var t = "undefined" == typeof Float32Array ? Array : Float32Array, e = {
            create: function () {
                ...
                var o = e[0], n = e[2], r = e[4], s = e[1], a = e[3], h = e[5], l = Math.sin(i), c = Math.cos(i);
                return t[0] = o * c + s * l, t[1] = -o * l + s * c, t[2] = n * c + a * l, t[3] = -n * l + c * a, t[4] = c * r + l * h, t[5] = c * h - l * r, t
        ...
        var o = t("../tool/matrix"), n = t("../tool/vector"), r = [0, 0], s = o.translate, a = 5e-5, h = function () {
                ...
                if (this.needTransform = this.needLocalTransform || t, this.needTransform) {
                    ...
                    if (o.identity(e), this.needLocalTransform) {
                        ...
                        if (i(n[0]) || i(n[1])) {
                            r[0] = -n[2] || 0, r[1] = -n[3] || 0;
                            var a = i(r[0]) || i(r[1]);
                            a && s(e, e, r), o.scale(e, e, n), a && (r[0] = -r[0], r[1] = -r[1], s(e, e, r))
                        }
                        if (this.rotation instanceof Array) {
                            if (0 !== this.rotation[0]) {
                                r[0] = -this.rotation[1] || 0, r[1] = -this.rotation[2] || 0;
                                var a = i(r[0]) || i(r[1]);
                                a && s(e, e, r), o.rotate(e, e, this.rotation[0]), a && (r[0] = -r[0], r[1] = -r[1], s(e, e, r))
                            }
        ...
        var n = t("./config"), r = t("./tool/util"), s = t("./tool/log"), a = t("./loadingEffect/Base"), h = t("./Layer"), l = function (t, i) {
            ...
            this._layers.hover = r, o.appendChild(r.dom), r.initContext(), r.dom.onselectstart = e, r.dom.style["-webkit-user-select"] = "none", r.dom.style["user-select"] = "none", r.dom.style["-webkit-touch-callout"] = "none", this.refreshNextFrame = null
        };
        return l.prototype.render = function (t) {
            ...
            for (var o = 0; o < this._zlevelList.length; o++) {
                var n = this._zlevelList[o], r = this._layers[n];
            ...
            for (var a = 0, h = t.length; h > a; a++) {
                var l = t[a];
                if (o !== l.zlevel && (i && (i.needTransform && r.restore(), r.flush && r.flush()), o = l.zlevel, i = this.getLayer(o), i.isBuildin || s("ZLevel " + o + " has been used by unkown layer " + i.id), r = i.ctx, i.unusedCount = 0, (i.dirty || e) && i.clear(), i.needTransform && (r.save(), i.setTransform(r))), (i.dirty || e) && !l.invisible && (!l.onbrush || l.onbrush && !l.onbrush(r, !1)))if (n.catchBrushException)try {
            ...
            if (i > 0 && t > this._zlevelList[0]) {
                ...
                n = this._layers[this._zlevelList[r]]
            }
            ...
            for (var i = 0; i < this._zlevelList.length; i++) {
                var o = this._zlevelList[i], n = this._layers[o];
            ...
            this.storage.iterShape(function (t) {
                if (!t.invisible && (!t.onbrush || t.onbrush && !t.onbrush(r, !1)))if (n.catchBrushException)try {
        ...
        }, l.prototype._shapeToImage = function (e, i, o, n, r) {
            ...
            return function (e, i, o, r) {
                return t._shapeToImage(e, i, o, r, n.devicePixelRatio)
            }
        }, l
        ...
        function s(t, e, i, o, n, r, s, h, l) {
            var c = t.length;
            if (1 == l)for (var d = 0; c > d; d++)h[d] = a(t[d], e[d], i[d], o[d], n, r, s); else for (var u = t[0].length, d = 0; c > d; d++)for (var p = 0; u > p; p++)h[d][p] = a(t[d][p], e[d][p], i[d][p], o[d][p], n, r, s)
        }
        ...
        m.prototype = {
            add: function (t) {
                ...
                for (var t = (new Date).getTime(), e = t - this._time, i = this._clips, o = i.length, n = [], r = [], s = 0; o > s; s++) {
                    ...
                    a.__inStep = !0;
                    var h = a.step(t);
                    a.__inStep = !1, h && (n.push(h), r.push(a))
                }
                for (var s = 0; o > s;)i[s].__needsRemove ? (i[s] = i[o - 1], i.pop(), o--) : s++;
                o = n.length;
            ...
            when: function (t, e) {
                ...
                var e = this, i = this._setter, h = this._getter, u = "spline" === t, p = function () {
                    ...
                    if (m) {
                        ...
                        if (m) {
                            b = f[m - 1].time;
                            for (var T = [], S = [], z = 0; m > z; z++) {
                                T.push(f[z].time / b);
                                var C = f[z].value;
                                "string" == typeof C && (C = d.toArray(C), 0 === C.length && (C[0] = C[1] = C[2] = 0, C[3] = 1), v = !0), S.push(C)
                            }
                            var E, z, w, L, A, M, k, I = 0, P = 0;
                            if (v)var O = [0, 0, 0, 0];
                            var D = function (t, r) {
                                if (P > r) {
                                    for (E = Math.min(I + 1, m - 1), z = E; z >= 0 && !(T[z] <= r); z--);
                                    z = Math.min(z, m - 2)
                                } else {
                                    for (z = I; m > z && !(T[z] > r); z++);
                                    z = Math.min(z - 1, m - 2)
                                ...
                                var c = T[z + 1] - T[z];
                                if (0 !== c) {
                                    if (w = (r - T[z]) / c, u)if (A = S[z], L = S[0 === z ? z : z - 1], M = S[z > m - 2 ? m - 1 : z + 1], k = S[z > m - 3 ? m - 1 : z + 2], y)s(L, A, M, k, w, w * w, w * w * w, h(t, g), x); else {
                                        var d;
                                        v ? (d = s(L, A, M, k, w, w * w, w * w * w, O, 1), d = l(O)) : d = a(L, A, M, k, w, w * w, w * w * w), i(t, g, d)
                                    } else if (y)n(S[z], S[z + 1], w, h(t, g), x); else {
                                        var d;
                                        v ? (n(S[z], S[z + 1], w, O, 1), d = l(O)) : d = o(S[z], S[z + 1], w), i(t, g, d)
                                    }
                                    for (z = 0; z < e._onframeList.length; z++)e._onframeList[z](t, r)
                                }
                            }, R = new c({
                                target: e._target,
                                life: b,
        ...
        var r = t("./config"), s = t("./tool/env"), a = t("./tool/event"), h = t("./tool/util"), l = t("./tool/vector"), c = t("./tool/matrix"), d = r.EVENT, u = t("./mixin/Eventful"), p = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], f = function (t) {
            ...
            resize: function (t) {
                ...
                if (f(t) || e) {
                    t = this._zrenderEventFixed(t);
                    var i = t.wheelDelta || -t.detail, o = i > 0 ? 1.1 : 1 / 1.1, n = !1, r = this._mouseX, s = this._mouseY;
                    this.painter.eachBuildinLayer(function (e) {
                        var i = e.position;
                        if (e.zoomable) {
                            e.__zoom = e.__zoom || 1;
                            var h = e.__zoom;
                            h *= o, h = Math.max(Math.min(e.maxZoom, h), e.minZoom), o = h / e.__zoom, e.__zoom = h, i[0] -= (r - i[0]) * (o - 1), i[1] -= (s - i[1]) * (o - 1), e.scale[0] *= o, e.scale[1] *= o, e.dirty = !0, n = !0, a.stop(t)
                        }
                    }), n && this.painter.refresh(), this._dispatchAgency(this._lastHover, d.MOUSEWHEEL, t), this._mousemoveHandler(t)
                }
                ...
                if ((f(t) || e) && !this.painter.isLoading()) {
                    ...
                    var i = this._mouseX - this._lastX, o = this._mouseY - this._lastY;
                    ...
                    var n = "default";
                    if (this._draggingTarget)this.storage.drift(this._draggingTarget.id, i, o), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++; else if (this._isMouseDown) {
                        var r = !1;
                        this.painter.eachBuildinLayer(function (t) {
                            t.panable && (n = "move", t.position[0] += i, t.position[1] += o, r = !0, t.dirty = !0)
                        }), r && this.painter.refresh()
                    }
                    this._draggingTarget || this._hasfound && this._lastHover.draggable ? n = "move" : this._hasfound && this._lastHover.clickable && (n = "pointer"), this.root.style.cursor = n, this._dispatchAgency(this._lastHover, d.MOUSEMOVE, t), (this._draggingTarget || this._hasfound || this.storage.hasHoverShape()) && this.painter.refreshHover()
                }
        ...
        m.prototype.on = function (t, e, i) {
            ...
            if (t)r.cancelBubble || this.dispatch(e, r); else if (!o) {
        ...
        function r(t, i, o, n, r, s) {
            var a = n + 3 * (i - o) - t, h = 3 * (o - 2 * i + t), l = 3 * (i - t), c = t - r, d = h * h - 3 * a * l, u = h * l - 9 * a * c, p = l * l - 3 * h * c, f = 0;
            if (e(d) && e(u))if (e(h))s[0] = 0; else {
                ...
                if (e(m)) {
                    ...
                    var z = (2 * d * h - 3 * a * u) / (2 * Math.sqrt(d * d * d)), C = Math.acos(z) / 3, E = Math.sqrt(d), w = Math.cos(C), g = (-h - 2 * E * w) / (3 * a), x = (-h + E * (w + _ * Math.sin(C))) / (3 * a), L = (-h + E * (w - _ * Math.sin(C))) / (3 * a);
        ...
        function s(t, o, n, r, s) {
            var a = 6 * n - 12 * o + 6 * t, h = 9 * o + 3 * r - 3 * t - 9 * n, l = 3 * o - 3 * t, c = 0;
            if (e(h)) {
                if (i(a)) {
                    var d = -l / a;
                    d >= 0 && 1 >= d && (s[c++] = d)
        ...
        function a(t, e, i, o, n, r) {
            var s = (e - t) * n + t, a = (i - e) * n + e, h = (o - i) * n + i, l = (a - s) * n + s, c = (h - a) * n + a, d = (c - l) * n + l;
            r[0] = t, r[1] = s, r[2] = l, r[3] = d, r[4] = d, r[5] = c, r[6] = h, r[7] = o
        }

        function h(t, e, i, n, r, s, a, h, l, c, d) {
            var u, p = .005, f = 1 / 0;
            v[0] = l, v[1] = c;
            for (var _ = 0; 1 > _; _ += .05) {
                x[0] = o(t, i, r, a, _), x[1] = o(e, n, s, h, _);
            ...
            for (var T = 0; 32 > T && !(m > p); T++) {
                var S = u - p, z = u + p;
                x[0] = o(t, i, r, a, S), x[1] = o(e, n, s, h, S);
                var y = g.distSquare(x, v);
                if (S >= 0 && f > y)u = S, f = y; else {
                    b[0] = o(t, i, r, a, z), b[1] = o(e, n, s, h, z);
                    var C = g.distSquare(b, v);
                    1 >= z && f > C ? (u = z, f = C) : p *= .5
                }
            }
            return d && (d[0] = o(t, i, r, a, u), d[1] = o(e, n, s, h, u)), Math.sqrt(f)
        }
        ...
        function d(t, o, n, r, s) {
            var a = t - 2 * o + n, h = 2 * (o - t), l = t - r, c = 0;
            if (e(a)) {
                if (i(h)) {
                    var d = -l / h;
                    d >= 0 && 1 >= d && (s[c++] = d)
        ...
        function p(t, e, i, o, n) {
            var r = (e - t) * o + t, s = (i - e) * o + e, a = (s - r) * o + r;
            n[0] = t, n[1] = r, n[2] = a, n[3] = a, n[4] = s, n[5] = i
        }
        ...
        function f(t, e, i, o, n, r, s, a, h) {
            ...
            for (var _ = 0; 32 > _ && !(m > d); _++) {
                var y = c - d, T = c + d;
                x[0] = l(t, i, n, y), x[1] = l(e, o, r, y);
                var f = g.distSquare(x, v);
                if (y >= 0 && u > f)c = y, u = f; else {
                    b[0] = l(t, i, n, T), b[1] = l(e, o, r, T);
                    var S = g.distSquare(b, v);
                    1 >= T && u > S ? (c = T, u = S) : d *= .5
                }
            }
            return h && (h[0] = l(t, i, n, c), h[1] = l(e, o, r, c)), Math.sqrt(u)
        }
        ...
        return i.prototype = {
            type: "rectangle", _buildRadiusPath: function (t, e) {
                var i, o, n, r, s = e.x, a = e.y, h = e.width, l = e.height, c = e.radius;
        ...
        function i(t, e, i) {
            var o = document.createElement(e), n = i.getWidth(), r = i.getHeight();
            return o.style.position = "absolute", o.style.left = 0, o.style.top = 0, o.style.width = n + "px", o.style.height = r + "px", o.width = n * s.devicePixelRatio, o.height = r * s.devicePixelRatio, o.setAttribute("data-zr-dom-id", t), o
        }

        var o = t("./mixin/Transformable"), n = t("./tool/util"), r = window.G_vmlCanvasManager, s = t("./config"), a = function (t, n) {
            this.id = t, this.dom = i(t, "canvas", n), this.dom.onselectstart = e, this.dom.style["-webkit-user-select"] = "none", this.dom.style["user-select"] = "none", this.dom.style["-webkit-touch-callout"] = "none", this.dom.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)", this.dom.className = s.elementClassName, r && r.initElement(this.dom), this.domBack = null, this.ctxBack = null, this.painter = n, this.unusedCount = 0, this.config = null, this.dirty = !0, this.elCount = 0, this.clearColor = 0, this.motionBlur = !1, this.lastFrameAlpha = .7, this.zoomable = !1, this.panable = !1, this.maxZoom = 1 / 0, this.minZoom = 0, o.call(this)
        };
        return a.prototype.initContext = function () {
            ...
            var t = this.dom, e = this.ctx, i = t.width, o = t.height, n = this.clearColor && !r, a = this.motionBlur && !r, h = this.lastFrameAlpha, l = s.devicePixelRatio;
            if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(t, 0, 0, i / l, o / l)), e.clearRect(0, 0, i / l, o / l), n && (e.save(), e.fillStyle = this.clearColor, e.fillRect(0, 0, i / l, o / l), e.restore()), a) {
                var c = this.domBack;
                e.save(), e.globalAlpha = h, e.drawImage(c, 0, 0, i / l, o / l), e.restore()
            }
        }, n.merge(a.prototype, o.prototype), a
    }), i("zrender/shape/Heart", ["require", "./Base", "./util/PathProxy", "../tool/area", "../tool/util"], function (t) {
        "use strict";
        var e = t("./Base"), i = t("./util/PathProxy"), o = t("../tool/area"), n = function (t) {
        ...
        return i.prototype = {
            type: "bezier-curve", buildPath: function (t, e) {
                ...
                if (t.__rect)return t.__rect;
                var e = Math.min(t.xStart, t.xEnd, t.cpX1), i = Math.min(t.yStart, t.yEnd, t.cpY1), o = Math.max(t.xStart, t.xEnd, t.cpX1), n = Math.max(t.yStart, t.yEnd, t.cpY1), r = t.cpX2, s = t.cpY2;
                "undefined" != typeof r && "undefined" != typeof s && (e = Math.min(e, r), i = Math.min(i, s), o = Math.max(o, r), n = Math.max(n, s));
                var a = t.lineWidth || 1;
                return t.__rect = {x: e - a, y: i - a, width: o - e + a, height: n - i + a}, t.__rect
            }
        }, t("../tool/util").inherits(i, e), i
        ...
        return function (t, o) {
            ...
            h = n > h ? n : h;
            for (var a = 0; h > a; a++) {
                var l, c, d, u = a / (h - 1) * (o ? n : n - 1), p = Math.floor(u), f = u - p, g = t[p % n];
                o ? (l = t[(p - 1 + n) % n], c = t[(p + 1) % n], d = t[(p + 2) % n]) : (l = t[0 === p ? p : p - 1], c = t[p > n - 2 ? n - 1 : p + 1], d = t[p > n - 3 ? n - 1 : p + 2]);
                var m = f * f, _ = f * m;
                r.push([e(l[0], g[0], c[0], d[0], f, m, _), e(l[1], g[1], c[1], d[1], f, m, _)])
            }
            return r
        }
        ...
        return {parsePercent: e, parseCenter: i, parseRadius: o, addCommas: n, getPrecision: r}
    }), i("echarts/data/KDTree", ["require", "./quickSelect"], function (t) {
        function e(t, e) {
            this.left = null, this.right = null, this.axis = t, this.data = e
        }

        var i = t("./quickSelect"), o = function (t, e) {
            t.length && (e || (e = t[0].array.length), this.dimension = e, this.root = this._buildTree(t, 0, t.length - 1, 0), this._stack = [], this._nearstNList = [])
        };
        return o.prototype._buildTree = function (t, o, n, r) {
            if (o > n)return null;
            var s = Math.floor((o + n) / 2);
            s = i(t, o, n, s, function (t, e) {
                return t.array[r] - e.array[r]
            });
            var a = t[s], h = new e(r, a);
            return r = (r + 1) % this.dimension, n > o && (h.left = this._buildTree(t, o, s - 1, r), h.right = this._buildTree(t, s + 1, n, r)), h
        }, o.prototype.nearest = function (t, e) {
            var i = this.root, o = this._stack, n = 0, r = 1 / 0, s = null;
            for (i.data !== t && (r = e(i.data, t), s = i), t.array[i.axis] < i.data.array[i.axis] ? (i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (i.left && (o[n++] = i.left), i.right && (o[n++] = i.right)); n--;) {
                i = o[n];
                var a = t.array[i.axis] - i.data.array[i.axis], h = 0 > a, l = !1;
                a *= a, r > a && (a = e(i.data, t), r > a && i.data !== t && (r = a, s = i), l = !0), h ? (l && i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (l && i.left && (o[n++] = i.left), i.right && (o[n++] = i.right))
            }
            return s.data
            ...
            for (var n = this.root, r = this._stack, s = 0, a = this._nearstNList, h = 0; e > h; h++)a[h] || (a[h] = {}), a[h].dist = 0, a[h].node = null;
            var l = i(n.data, t), c = 0;
            for (n.data !== t && (c++, this._addNearest(c, l, n)), t.array[n.axis] < n.data.array[n.axis] ? (n.right && (r[s++] = n.right), n.left && (r[s++] = n.left)) : (n.left && (r[s++] = n.left), n.right && (r[s++] = n.right)); s--;) {
                n = r[s];
                var l = t.array[n.axis] - n.data.array[n.axis], d = 0 > l, u = !1;
                l *= l, (e > c || l < a[c - 1].dist) && (l = i(n.data, t), (e > c || l < a[c - 1].dist) && n.data !== t && (e > c && c++, this._addNearest(c, l, n)), u = !0), d ? (u && n.right && (r[s++] = n.right), n.left && (r[s++] = n.left)) : (u && n.left && (r[s++] = n.left), n.right && (r[s++] = n.right))
            }
            for (var h = 0; c > h; h++)o[h] = a[h].node.data;
            return o.length = c, o
        }, o
        ...
        function i(t, i, o, n, r) {
            for (var s = i; o > i;) {
                var s = Math.round((o + i) / 2), a = t[s];
                e(t, s, o), s = i;
                for (var h = i; o - 1 >= h; h++)r(a, t[h]) >= 0 && (e(t, h, s), s++);
                if (e(t, o, s), s === n)return s;
                n > s ? i = s + 1 : o = s - 1
            }
            return i
        }
        ...
        function o(e, o, n, r, s) {
            return arguments.length <= 3 && (r = o, s = 2 == arguments.length ? t : n, o = 0, n = e.length - 1), i(e, o, n, r, s)
        }
        ...
        var i = t("./base"), o = t("zrender/shape/Text"), n = t("zrender/shape/Line"), r = t("zrender/shape/Rectangle"), s = t("../config");
        s.categoryAxis = {
            zlevel: 0,
            z: 0,
            show: !0,
        ...
        return e.prototype = {
            type: s.COMPONENT_TYPE_AXIS_CATEGORY, _getReformedLabel: function (t) {
                var e = this.getDataFromOption(this.option.data[t]), i = this.option.data[t].formatter || this.option.axisLabel.formatter;
                ...
                if ("auto" == t) {
                    ...
                    if (this.isHorizontal())if (o > 3) {
                        var n, r, s = this.getGap(), l = !1, c = Math.floor(.5 / s);
                        for (c = 1 > c ? 1 : c, t = Math.floor(15 / s); !l && o > t;) {
                            t += c, l = !0, n = Math.floor(s * t);
                            for (var d = Math.floor((o - 1) / t) * t; d >= 0; d -= t) {
                                if (0 !== this.option.axisLabel.rotate)r = e; else if (i[d].textStyle)r = h.getTextWidth(this._getReformedLabel(d), this.getFont(a.merge(i[d].textStyle, this.option.axisLabel.textStyle))); else {
                                    var u = this._getReformedLabel(d) + "", p = (u.match(/\w/g) || "").length, f = u.length - p;
                                    r = p * e * 2 / 3 + f * e
                                }
                                if (r > n) {
                                    l = !1;
                ...
                var t, e = this.option.data, i = this.option.data.length, o = this.option.axisTick, r = o.length, s = o.lineStyle.color, a = o.lineStyle.width, h = "function" == typeof o.interval ? o.interval : "auto" == o.interval && "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, l = h ? 1 : "auto" == o.interval ? this._interval : o.interval - 0 + 1, c = o.onGap, d = c ? this.getGap() / 2 : "undefined" == typeof c && this.option.boundaryGap ? this.getGap() / 2 : 0, u = d > 0 ? -l : 0;
                if (this.isHorizontal())for (var p, f = "bottom" == this.option.position ? o.inside ? this.grid.getYend() - r - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - r - 1, g = u; i > g; g += l)(!h || h(g, e[g])) && (p = this.subPixelOptimize(this.getCoordByIndex(g) + (g >= 0 ? d : 0), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {xStart: p, yStart: f, xEnd: p, yEnd: f + r, strokeColor: s, lineWidth: a}
                }, this.shapeList.push(new n(t))); else for (var m, _ = "left" == this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - r - 1 : o.inside ? this.grid.getXend() - r - 1 : this.grid.getXend() + 1, g = u; i > g; g += l)(!h || h(g, e[g])) && (m = this.subPixelOptimize(this.getCoordByIndex(g) - (g >= 0 ? d : 0), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {xStart: _, yStart: m, xEnd: _ + r, yEnd: m, strokeColor: s, lineWidth: a}
                }, this.shapeList.push(new n(t)))
            }, _buildAxisLabel: function () {
                var t, e, i = this.option.data, n = this.option.data.length, r = this.option.axisLabel, s = r.rotate, h = r.margin, l = r.clickable, c = r.textStyle, d = "function" == typeof r.interval ? r.interval : !1;
                if (this.isHorizontal()) {
                    var u, p;
                    "bottom" == this.option.position ? (u = this.grid.getYend() + h, p = "top") : (u = this.grid.getY() - h, p = "bottom");
                    for (var f = 0; n > f; f += this._interval)d && !d(f, i[f]) || "" === this._getReformedLabel(f) || (e = a.merge(i[f].textStyle || {}, c), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                        style: {
                    ...
                    }, s && (t.style.textAlign = s > 0 ? "bottom" == this.option.position ? "right" : "left" : "bottom" == this.option.position ? "left" : "right", t.rotation = [s * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(l, t))))
                } else {
                    var g, m;
                    ...
                    }, s && (t.rotation = [s * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(l, t))))
                }
            }, _buildSplitLine: function () {
                var t, e = this.option.data, i = this.option.data.length, o = this.option.splitLine, r = o.lineStyle.type, s = o.lineStyle.width, a = o.lineStyle.color;
                a = a instanceof Array ? a : [a];
                var h = a.length, l = "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, c = o.onGap, d = c ? this.getGap() / 2 : "undefined" == typeof c && this.option.boundaryGap ? this.getGap() / 2 : 0;
                if (i -= c || "undefined" == typeof c && this.option.boundaryGap ? 1 : 0, this.isHorizontal())for (var u, p = this.grid.getY(), f = this.grid.getYend(), g = 0; i > g; g += this._interval)(!l || l(g, e[g])) && (u = this.subPixelOptimize(this.getCoordByIndex(g) + d, s), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
                ...
                }, this.shapeList.push(new n(t))); else for (var m, _ = this.grid.getX(), y = this.grid.getXend(), g = 0; i > g; g += this._interval)(!l || l(g, e[g])) && (m = this.subPixelOptimize(this.getCoordByIndex(g) - d, s), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
                ...
                if (o instanceof Array) {
                    var n = o.length, s = this.option.data.length, a = "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, h = i.onGap, l = h ? this.getGap() / 2 : "undefined" == typeof h && this.option.boundaryGap ? this.getGap() / 2 : 0;
                    if (this.isHorizontal())for (var c, d = this.grid.getY(), u = this.grid.getHeight(), p = this.grid.getX(), f = 0; s >= f; f += this._interval)a && !a(f, e[f]) && s > f || (c = s > f ? this.getCoordByIndex(f) + l : this.grid.getXend(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {x: p, y: d, width: c - p, height: u, color: o[f / this._interval % n]}
                    }, this.shapeList.push(new r(t)), p = c); else for (var g, m = this.grid.getX(), _ = this.grid.getWidth(), y = this.grid.getYend(), f = 0; s >= f; f += this._interval)a && !a(f, e[f]) && s > f || (g = s > f ? this.getCoordByIndex(f) - l : this.grid.getY(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {x: m, y: g, width: _, height: y - g, color: o[f / this._interval % n]}
                    }, this.shapeList.push(new r(t)), y = g)
                } else t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                ...
                for (var e = this.option.data, i = e.length, o = this.getGap(), n = this.option.boundaryGap ? o / 2 : 0, r = 0; i > r; r++) {
                    if (this.getDataFromOption(e[r]) == t)return n = this.isHorizontal() ? this.grid.getX() + n : this.grid.getYend() - n;
                    n += o
                }
                ...
                for (var e = this.option.data, i = e.length, o = 0; i > o; o++)if (this.getDataFromOption(e[o]) == t)return o;
                return -1
        ...
        return e.prototype = {
            type: s.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
                ...
                if (this.isHorizontal())for (var h, l = "bottom" === this.option.position ? o.inside ? this.grid.getYend() - r - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - r - 1, c = 0; i > c; c++)h = this.subPixelOptimize(this.getCoord(e[c]), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {xStart: h, yStart: l, xEnd: h, yEnd: l + r, strokeColor: s, lineWidth: a}
                }, this.shapeList.push(new n(t)); else for (var d, u = "left" === this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - r - 1 : o.inside ? this.grid.getXend() - r - 1 : this.grid.getXend() + 1, c = 0; i > c; c++)d = this.subPixelOptimize(this.getCoord(e[c]), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {xStart: u, yStart: d, xEnd: u + r, yEnd: d, strokeColor: s, lineWidth: a}
                }, this.shapeList.push(new n(t))
            }, _buildAxisLabel: function () {
                ...
                a = a instanceof Array ? a : [a];
                var h = a.length;
                if (this.isHorizontal())for (var l, c = this.grid.getY(), d = this.grid.getYend(), u = 0; i > u; u++)l = this.subPixelOptimize(this.getCoord(e[u]), s), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {xStart: l, yStart: c, xEnd: l, yEnd: d, strokeColor: a[u % h], lineType: r, lineWidth: s}
                ...
                if (e instanceof Array) {
                    ...
                    if (this.isHorizontal())for (var s, a = this.grid.getY(), h = this.grid.getHeight(), l = this.grid.getX(), c = 0; n >= c; c++)s = n > c ? this.getCoord(o[c]) : this.grid.getXend(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {x: l, y: a, width: s - l, height: h, color: e[c % i]}
                    }, this.shapeList.push(new r(t)), l = s; else for (var d, u = this.grid.getX(), p = this.grid.getWidth(), f = this.grid.getYend(), c = 0; n >= c; c++)d = n > c ? this.getCoord(o[c]) : this.grid.getY(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {x: u, y: d, width: p, height: f - d, color: e[c % i]}
                ...
                if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                    ...
                    var c = "log" !== this.option.type ? this.option.boundaryGap : [0, 0], d = Math.abs(this._max - this._min);
                ...
                if (this.series[e].stack) {
                    ...
                    for (var l = 0, c = o.length; c > l; l++)i = this.getDataFromOption(o[l]), "-" !== i && (i -= 0, i >= 0 ? null != t[r][l] ? t[r][l] += i : t[r][l] = i : null != t[h][l] ? t[h][l] += i : t[h][l] = i, this.option.scale && t[n].push(i))
                    ...
                    o = this.series[e].data;
                    for (var l = 0, c = o.length; c > l; l++)for (var d = o[l].evolution, u = 0, p = d.length; p > u; u++)t[n].push(a.getNewDate(d[u].time))
                }
                ...
                var e = this.option, i = t("../util/smartLogSteps")({
                    dataMin: this._min,
                    dataMax: this._max,
                ...
                if (e)for (var i = 0, o = this._valueList.length; o > i; i++)"function" == typeof e ? this._valueLabel.push(t ? e.call(this.myChart, this._valueList[i], t) : e.call(this.myChart, this._valueList[i])) : "string" == typeof e && this._valueLabel.push(t ? a.format(e, this._valueList[i]) : e.replace("{value}", this._valueList[i])); else for (var i = 0, o = this._valueList.length; o > i; i++)this._valueLabel.push(t ? t(this._valueList[i]) : this.numAddCommas(this._valueList[i]))
            }, getExtremum: function () {
                this._calculateValue();
                var t = this._dataMappingMethods;
                return {min: this._min, max: this._max, dataMappingMethods: t ? h.merge({}, t) : null}
        ...
        return e.prototype = {
            ...
            _optionToContent: function () {
                ...
                for (t = 0, n = c.length; n > t; t++) {
                    for (s = [], e = 0, i = c[t].data.length; i > e; e++)r = c[t].data[e], l = c[t].type == o.CHART_TYPE_PIE || c[t].type == o.CHART_TYPE_MAP ? (r.name || "-") + ":" : "", c[t].type == o.CHART_TYPE_SCATTER && (r = this.getDataFromOption(r).join(", ")), s.push(l + this.getDataFromOption(r));
            ...
            _save: function () {
                ...
                if ("function" != typeof t) {
                    for (var e = this._textArea.value.split("\n"), i = [], n = 0, r = e.length; r > n; n++)e[n] = this._trim(e[n]), "" !== e[n] && i.push(e[n]);
            ...
            _contentToOption: function (t) {
                ...
                if (this.option.xAxis)for (l = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis], e = 0, r = l.length; r > e; e++)if ("category" == (l[e].type || "category")) {
                    for (a = t[c].split(","), i = 0, n = l[e].data.length; n > i; i++)h = this._trim(a[i] || ""), s = l[e].data[i], "undefined" != typeof l[e].data[i].value ? l[e].data[i].value = h : l[e].data[i] = h;
                    c++
                }
                ...
                for (e = 0, r = d.length; r > e; e++)if (c++, d[e].type == o.CHART_TYPE_SCATTER)for (var i = 0, n = d[e].data.length; n > i; i++)a = t[c], h = a.replace(" ", "").split(","), "undefined" != typeof d[e].data[i].value ? d[e].data[i].value = h : d[e].data[i] = h, c++; else {
                    a = t[c].split(",");
                    for (var i = 0, n = d[e].data.length; n > i; i++)h = (a[i] || "").replace(/.*:/, ""), h = this._trim(h), h = "-" != h && "" !== h ? h - 0 : "-", "undefined" != typeof d[e].data[i].value ? d[e].data[i].value = h : d[e].data[i] = h;
                    c++
                }
            },
            _trim: function (t) {
        ...
        function o(t, e, o, n) {
            v = n || {}, x = v.steps || z, b = v.secs || C, o = w(+o || 0) % 99, t = +t || 0, e = +e || 0, T = S = 0, "min" in v && (t = +v.min || 0, T = 1), "max" in v && (e = +v.max || 0, S = 1), t > e && (e = [t, t = e][0]);
            var r = e - t;
        ...
        function n(t, i, o, n) {
            n = n || 0;
            var a = r((i - t) / o, -1), h = r(t, -1, 1), l = r(i, -1), c = E.min(a.e, h.e, l.e);
            0 === h.c ? c = E.min(a.e, l.e) : 0 === l.c && (c = E.min(a.e, h.e)), s(a, {
                c: 0,
                e: c
            }), s(h, a, 1), s(l, a), n += c, t = h.c, i = l.c;
            ...
            return b = 0, x = 0, v = 0, {min: t, max: i, secs: o, step: d, fix: p, exp: n, pnts: f}
        }

        function r(o, n, r) {
            n = w(n % 10) || 2, 0 > n && (i(o) ? n = ("" + M(o)).replace(/0+$/, "").length || 1 : (o = o.toFixed(15).replace(/0+$/, ""), n = o.replace(".", "").replace(/^[-0]+/, "").length, o = +o));
            var s = L(t(o)) - n + 1, a = +(o * e(-s)).toFixed(15) || 0;
            return a = r ? L(a) : A(a), !a && (s = 0), ("" + M(a)).length > n && (s += 1, a /= 10), {c: a, e: s}
        }

        function s(t, i, o) {
            var n = i.e - t.e;
            n && (t.e += n, t.c *= e(-n), t.c = o ? L(t.c) : A(t.c))
        }
        ...
        function l(t, e, o) {
            ...
            if (s(m, f), s(y, f, 1), s(v, f), o ? a = d(y, v, l) : l = c(y, v), i(t) && i(e) && t * e >= 0) {
                if (l > e - t)return p(t, e, l);
                l = u(t, e, o, y, v, l)
            }
            var z = g(t, e, y.c, v.c);
            return y.c = z[0], v.c = z[1], (T || S) && _(t, e, y, v), n(y.c, v.c, l, v.e)
        }

        function c(t, i) {
            for (var o, n, r, s, a = [], l = b.length; l--;)o = b[l], n = h((i.c - t.c) / o, x), n = n.c * e(n.e), r = L(t.c / n) * n, s = A(i.c / n) * n, a[l] = {
                min: r,
                max: s,
                step: n,
                span: s - r
        ...
        function d(t, i, o) {
            for (var n, r, s = i.c, a = (i.c - t.c) / o - 1; s > t.c;)a = h(a + 1, x), a = a.c * e(a.e), n = a * o, r = A(i.c / a) * a, s = r - n;
        ...
        function u(t, o, n, r, s, a) {
            ...
            if (!i(l) && (l = L(l), h = l * a, o - t > h && (l += 1, h = l * a, !n && l * (a - 1) >= o - t && (a -= 1, h = l * a)), h >= o - t)) {
                var c = h - (o - t);
                r.c = w(t - c / 2), s.c = w(o + c / 2), r.e = 0, s.e = 0
            }
            return a
        }
        ...
        function p(t, e, i) {
            if (i = i || 5, T)e = t + i; else if (S)t = e - i; else {
                var o = i - (e - t), r = w(t - o / 2), s = w(e + o / 2), a = g(t, e, r, s);
                t = a[0], e = a[1]
            }
            return n(t, e, i)
        }
        ...
        function y(t, e, i) {
            var o = i ? [i] : b, a = e - t;
            if (0 === a)return e = r(e, 3), i = o[0], e.c = w(e.c + i / 2), n(e.c - i, e.c, i, e.e);
            ...
            for (var _ = o.length; _--;) {
                i = o[_], h = A(a / i), l = h * i - a, c = 3 * (l + 3), c += 2 * (i - o[0] + 2), i % 5 === 0 && (c -= 10);
                for (var y = d.length; y--;)h % d[y][0] === 0 && (c /= d[y][1]);
                p[_] = [i, h, l, c].join(), u[_] = {secs: i, step: h, delta: l, score: c}
            }
            return u.sort(function (t, e) {
                return t.score - e.score
            }), u = u[0], g.c = w(g.c - u.delta / 2), m.c = w(m.c + u.delta / 2), n(g.c, m.c, u.secs, f.e)
        }

        var v, x, b, T, S, z = [10, 20, 25, 50], C = [4, 5, 6], E = Math, w = E.round, L = E.floor, A = E.ceil, M = E.abs;
        return o
    }), i("echarts/util/smartLogSteps", ["require", "./number"], function (t) {
        function e(t) {
            return i(), m = t || {}, o(), n(), [r(), i()][0]
        }

        function i() {
            u = m = y = g = v = x = _ = b = p = f = null
        }

        function o() {
            p = m.logLabelBase, null == p ? (f = "plain", p = 10, g = M) : (p = +p, 1 > p && (p = 10), f = "exponent", g = z(p)), _ = m.splitNumber, null == _ && (_ = O);
            var t = parseFloat(m.dataMin), e = parseFloat(m.dataMax);
            isFinite(t) || isFinite(e) ? isFinite(t) ? isFinite(e) ? t > e && (e = [t, t = e][0]) : e = t : t = e : t = e = 1, u = m.logPositive, null == u && (u = e > 0 || 0 === t), v = u ? t : -e, x = u ? e : -t, P > v && (v = P), P > x && (x = P)
        }

        function n() {
            function t() {
                _ > c && (_ = c);
                var t = L(h(c / _)), e = w(h(c / t)), i = t * e, o = (i - u) / 2, n = L(h(s - o));
                d(n - s) && (n -= 1), y = -n * g;
                for (var a = n; r >= a - t; a += t)b.push(C(p, a))
            }

            function e() {
                for (var t = i(l, 0), e = t + 2; e > t && n(t + 1) + o(t + 1) * I < s;)t++;
                for (var h = i(a, 0), e = h - 2; h > e && n(h - 1) + o(h - 1) * I > r;)h--;
                y = -(n(t) * M + o(t) * k);
                for (var c = t; h >= c; c++) {
                    var d = n(c), u = o(c);
                    b.push(C(10, d) * C(2, u))
            ...
            b = [];
            var r = h(z(x) / g), s = h(z(v) / g), a = w(r), l = L(s), c = a - l, u = r - s;
            "exponent" === f ? t() : D >= c && _ > D ? e() : t()
        }

        function r() {
            for (var t = [], e = 0, i = b.length; i > e; e++)t[e] = (u ? 1 : -1) * b[e];
            !u && t.reverse();
            var o = a(), n = o.value2Coord, r = n(t[0]), h = n(t[t.length - 1]);
            return r === h && (r -= 1, h += 1), {
                dataMin: r,
                dataMax: h,
                tickList: t,
        ...
        function a() {
            ...
            return {
                value2Coord: function (i) {
                    return null == i || isNaN(i) || !isFinite(i) ? i : (i = parseFloat(i), isFinite(i) ? t && P > i ? i = P : !t && i > -P && (i = -P) : i = P, i = E(i), (t ? 1 : -1) * (z(i) + e))
                }, coord2Value: function (i) {
                    return null == i || isNaN(i) || !isFinite(i) ? i : (i = parseFloat(i), isFinite(i) || (i = P), t ? C(A, i - e) : -C(A, -i + e))
                }
            }
        }
        ...
        var u, p, f, g, m, _, y, v, x, b, T = t("./number"), S = Math, z = S.log, C = S.pow, E = S.abs, w = S.ceil, L = S.floor, A = S.E, M = S.LN10, k = S.LN2, I = k / M, P = 1e-9, O = 5, D = 2, R = {
            0: "⁰",
            1: "¹",
            2: "²",
            3: "³",
        ...
        function t(t, e, i) {
            i = i > 1 ? i : 2;
            for (var o, n, r, s, a = 0, h = c.length; h > a; a++)if (o = c[a].value, n = Math.ceil(e / o) * o - Math.floor(t / o) * o, Math.round(n / o) <= 1.2 * i) {
        ...
        function i(t, i) {
            ...
            return t = t.replace("MM", e(r)), t = t.toLowerCase(), t = t.replace("yyyy", n), t = t.replace("yy", n % 100), t = t.replace("dd", e(s)), t = t.replace("d", s), t = t.replace("hh", e(a)), t = t.replace("h", a), t = t.replace("mm", e(h)), t = t.replace("m", h), t = t.replace("ss", e(c)), t = t.replace("s", c)
        }
        ...
        var c = [{formatter: "hh : mm : ss", value: 1e3}, {
            formatter: "hh : mm : ss",
            value: 5e3
        ...
        return l.prototype = {
            type: "sector", buildPath: function (t, i) {
                ...
                t.moveTo(c * r + o, d * r + n), t.lineTo(c * s + o, d * s + n), t.arc(o, n, s, a, h, !l), t.lineTo(e.cos(h) * r + o, e.sin(h) * r + n), 0 !== r && t.arc(o, n, r, h, a, l), t.closePath()
            }, getRect: function (t) {
                if (t.__rect)return t.__rect;
                var n = t.x, l = t.y, c = t.r0 || 0, d = t.r, u = e.degreeToRadian(t.startAngle), p = e.degreeToRadian(t.endAngle), f = t.clockWise;
                return f || (u = -u, p = -p), c > 1 ? i.arc(n, l, c, u, p, !f, r, a) : (r[0] = a[0] = n, r[1] = a[1] = l), i.arc(n, l, d, u, p, !f, s, h), o.min(r, r, s), o.max(a, a, h), t.__rect = {
                    x: r[0],
                    y: r[1],
                    width: a[0] - r[0],
                    height: a[1] - r[1]
        ...
        function o(t, e, i, o, n) {
            ...
            o[0] = Math.min(t[0], i[0], c, u), o[1] = Math.min(t[1], i[1], d, p), n[0] = Math.max(t[0], i[0], c, u), n[1] = Math.max(t[1], i[1], d, p)
        }

        var n = t("./vector"), r = t("./curve"), s = n.create(), a = n.create(), h = n.create(), l = function (t, e, i, o, r, l, c, d) {
            if (Math.abs(o - r) >= 2 * Math.PI)return c[0] = t - i, c[1] = e - i, d[0] = t + i, void(d[1] = e + i);
            if (s[0] = Math.cos(o) * i + t, s[1] = Math.sin(o) * i + e, a[0] = Math.cos(r) * i + t, a[1] = Math.sin(r) * i + e, n.min(c, s, a), n.max(d, s, a), o %= 2 * Math.PI, 0 > o && (o += 2 * Math.PI), r %= 2 * Math.PI, 0 > r && (r += 2 * Math.PI), o > r && !l ? r += 2 * Math.PI : r > o && l && (o += 2 * Math.PI), l) {
                var u = r;
                r = o, o = u
            }
            for (var p = 0; r > p; p += Math.PI / 2)p > o && (h[0] = Math.cos(p) * i + t, h[1] = Math.sin(p) * i + e, n.min(c, h, c), n.max(d, h, d))
        };
    ...
    var n = e("echarts");
    return n.config = e("echarts/config"), e("echarts/chart/line"), e("echarts/chart/k"), t.echarts = n, t.zrender = o, n
}(window);